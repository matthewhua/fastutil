...
public abstract class AbstractLongList extends AbstractLongCollection implements LongList , LongStack {
	...
	public LongListIterator listIterator(final int index) {
	 ...
	 return new LongIterators.AbstractIndexBasedListIterator (0, index) {
	  @Override
	  protected final long get(int i) { return AbstractLongList.this.getLong(i); }
	  @Override
	  protected final void add(int i, long k) { AbstractLongList.this.add(i, k); }
	  @Override
	  protected final void set(int i, long k) { AbstractLongList.this.set(i, k); }
	  @Override
	  protected final void remove(int i) { AbstractLongList.this.removeLong(i); }
	  @Override
	  protected final int getMaxPos() { return AbstractLongList.this.size(); }
	 };
	}
	static final class IndexBasedSpliterator extends LongSpliterators.LateBindingSizeIndexBasedSpliterator {
	 ...
	 @Override
	 protected final long get(int i) { return l.getLong(i); }
	 @Override
	...
	public static class LongSubList extends AbstractLongList implements java.io.Serializable {
	 ...
	 private final class RandomAccessIter extends LongIterators.AbstractIndexBasedListIterator {
	  ...
	  @Override
	  protected final long get(int i) { return l.getLong(from + i); }
	  // Remember, these are calling SUBLIST's methods, meaning 0 is the start of the sublist for these.
	  @Override
	  protected final void add(int i, long k) { LongSubList.this.add(i, k); }
	  @Override
	  protected final void set(int i, long k) { LongSubList.this.set(i, k); }
	  @Override
	  protected final void remove(int i) { LongSubList.this.removeLong(i); }
	  @Override
