...
public final class Short2DoubleFunctions {
	...
	public static class EmptyFunction extends AbstractShort2DoubleFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public double getOrDefault(final short k, final double defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractShort2DoubleFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public double getOrDefault(final short k, final double defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Short2DoubleFunction , java.io.Serializable {
	 ...
	 @Override
	 public double getOrDefault(final short k, final double defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractShort2DoubleFunction implements java.io.Serializable {
	 ...
	 @Override
	 public double getOrDefault(final short k, final double defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
