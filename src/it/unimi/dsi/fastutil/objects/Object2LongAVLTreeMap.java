	...
	public ObjectSortedSet<Object2LongMap.Entry <K> > object2LongEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2LongMap.Entry <K> >() {
	   final Comparator<? super Object2LongMap.Entry <K> > comparator = (Object2LongAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Object2LongMap.Entry <K> >) (x, y) -> ( ((Comparable<K>)(x.getKey())).compareTo(y.getKey()) ) :
	    (Comparator<Object2LongMap.Entry <K> >) (x, y) -> Object2LongAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey())
	   );
	   @Override
