...
public final class Short2LongFunctions {
	...
	public static class EmptyFunction extends AbstractShort2LongFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long getOrDefault(final short k, final long defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractShort2LongFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long getOrDefault(final short k, final long defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Short2LongFunction , java.io.Serializable {
	 ...
	 @Override
	 public long getOrDefault(final short k, final long defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractShort2LongFunction implements java.io.Serializable {
	 ...
	 @Override
	 public long getOrDefault(final short k, final long defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
