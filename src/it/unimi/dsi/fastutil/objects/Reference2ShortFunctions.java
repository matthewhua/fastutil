...
public final class Reference2ShortFunctions {
	...
	public static class Singleton <K> extends AbstractReference2ShortFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short getOrDefault(final Object k, final short defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class UnmodifiableFunction <K> extends AbstractReference2ShortFunction <K> implements java.io.Serializable {
	 ...
	 public short getOrDefault(final Object k, final short defaultValue) { return ((Reference2ShortFunction <K>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 */
	public static <K> Reference2ShortFunction <K> unmodifiable(final Reference2ShortFunction <? extends K> f) { return new UnmodifiableFunction <>(f); }
