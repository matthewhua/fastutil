...
public final class Long2ShortFunctions {
	...
	public static class EmptyFunction extends AbstractLong2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short getOrDefault(final long k, final short defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractLong2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short getOrDefault(final long k, final short defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Long2ShortFunction , java.io.Serializable {
	 ...
	 @Override
	 public short getOrDefault(final long k, final short defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractLong2ShortFunction implements java.io.Serializable {
	 ...
	 @Override
	 public short getOrDefault(final long k, final short defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
