...
default it.unimi.dsi.fastutil.objects.Object2ByteFunction <K> andThenByte(it.unimi.dsi.fastutil.bytes.Byte2ByteFunction after) { return k -> after.get(getByte(k)); } default it.unimi.dsi.fastutil.bytes.Byte2ByteFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2ObjectFunction <K> before) { return k -> getByte(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Object2ShortFunction <K> andThenShort(it.unimi.dsi.fastutil.bytes.Byte2ShortFunction after) { return k -> after.get(getByte(k)); } default it.unimi.dsi.fastutil.shorts.Short2ByteFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2ObjectFunction <K> before) { return k -> getByte(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Object2IntFunction <K> andThenInt(it.unimi.dsi.fastutil.bytes.Byte2IntFunction after) { return k -> after.get(getByte(k)); } default it.unimi.dsi.fastutil.ints.Int2ByteFunction composeInt(it.unimi.dsi.fastutil.ints.Int2ObjectFunction <K> before) { return k -> getByte(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Object2LongFunction <K> andThenLong(it.unimi.dsi.fastutil.bytes.Byte2LongFunction after) { return k -> after.get(getByte(k)); } default it.unimi.dsi.fastutil.longs.Long2ByteFunction composeLong(it.unimi.dsi.fastutil.longs.Long2ObjectFunction <K> before) { return k -> getByte(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Object2CharFunction <K> andThenChar(it.unimi.dsi.fastutil.bytes.Byte2CharFunction after) { return k -> after.get(getByte(k)); } default it.unimi.dsi.fastutil.chars.Char2ByteFunction composeChar(it.unimi.dsi.fastutil.chars.Char2ObjectFunction <K> before) { return k -> getByte(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Object2FloatFunction <K> andThenFloat(it.unimi.dsi.fastutil.bytes.Byte2FloatFunction after) { return k -> after.get(getByte(k)); } default it.unimi.dsi.fastutil.floats.Float2ByteFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2ObjectFunction <K> before) { return k -> getByte(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Object2DoubleFunction <K> andThenDouble(it.unimi.dsi.fastutil.bytes.Byte2DoubleFunction after) { return k -> after.get(getByte(k)); } default it.unimi.dsi.fastutil.doubles.Double2ByteFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2ObjectFunction <K> before) { return k -> getByte(before.get(k)); }
default <T> it.unimi.dsi.fastutil.objects.Object2ObjectFunction <K, T> andThenObject(it.unimi.dsi.fastutil.bytes.Byte2ObjectFunction <? extends T> after) { return k -> after.get(getByte(k)); } default <T> it.unimi.dsi.fastutil.objects.Object2ByteFunction <T> composeObject(it.unimi.dsi.fastutil.objects.Object2ObjectFunction <? super T, ? extends K> before) { return k -> getByte(before.get(k)); }
default <T> it.unimi.dsi.fastutil.objects.Object2ReferenceFunction <K, T> andThenReference(it.unimi.dsi.fastutil.bytes.Byte2ReferenceFunction <? extends T> after) { return k -> after.get(getByte(k)); } default <T> it.unimi.dsi.fastutil.objects.Reference2ByteFunction <T> composeReference(it.unimi.dsi.fastutil.objects.Reference2ObjectFunction <? super T, ? extends K> before) { return k -> getByte(before.get(k)); }
}
