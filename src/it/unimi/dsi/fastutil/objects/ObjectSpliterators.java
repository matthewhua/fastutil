...
public final class ObjectSpliterators {
	...
	public static class EmptySpliterator <K> implements ObjectSpliterator <K>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean tryAdvance(final Consumer<? super K> action) { return false; }
	 @Override
	 public ObjectSpliterator <K> trySplit() { return null; }
	 @Override
	...
	public static <K> ObjectSpliterator <K> emptySpliterator() { return EMPTY_SPLITERATOR; }
	...
	public static <K> ObjectSpliterator <K> wrapPreSorted(
	  final K[] array, final int offset, final int length, final int additionalCharacteristics, Comparator <? super K> comparator) {
	 ObjectArrays.ensureOffsetLength(array, offset, length);
	 ...
	 */
	public static <K> ObjectSpliterator <K> wrapPreSorted(
	  final K[] array, final int offset, final int length, Comparator <? super K> comparator) {
	 ...
	 */
	public static <K> ObjectSpliterator <K> wrapPreSorted(
	  final K[] array, Comparator <? super K> comparator) {
	...
	public static <K> ObjectSpliterator <K> asSpliteratorFromSorted(
	  final ObjectIterator <? extends K> iter, final long size, final int additionalCharacterisitcs, final Comparator <? super K> comparator) {
