...
public final class Object2DoubleMaps {
	...
	public static <K> ObjectIterable<Object2DoubleMap.Entry <K> > fastIterable(Object2DoubleMap <K> map) {
	 ...
	 return entries instanceof Object2DoubleMap.FastEntrySet ? new ObjectIterable<Object2DoubleMap.Entry <K> >() {
	  ...
	  @Override
	  public ObjectSpliterator<Object2DoubleMap.Entry <K> > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class SynchronizedMap <K> extends Object2DoubleFunctions.SynchronizedFunction <K> implements Object2DoubleMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public double computeIfAbsent(final K key, final Object2DoubleFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap <K> extends Object2DoubleFunctions.UnmodifiableFunction <K> implements Object2DoubleMap <K>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Object2DoubleMap.Entry <K> > object2DoubleEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2DoubleEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public double getOrDefault(final Object key, final double defaultValue) { return ((Object2DoubleMap <K>)map).getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 @Override
	 public double computeIfAbsent(final K key, final Object2DoubleFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 */
	public static <K> Object2DoubleMap <K> unmodifiable(final Object2DoubleMap <? extends K> m) { return new UnmodifiableMap <>(m); }
}
