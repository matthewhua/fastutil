...
public final class Int2ObjectSortedMaps {
	...
	public static class UnmodifiableSortedMap <V> extends Int2ObjectMaps.UnmodifiableMap <V> implements Int2ObjectSortedMap <V>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "rawtypes", "unchecked" })
	 @Override
	 public ObjectSortedSet<Int2ObjectMap.Entry <V> > int2ObjectEntrySet() { if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.int2ObjectEntrySet()); return (ObjectSortedSet<Int2ObjectMap.Entry <V> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <V> Int2ObjectSortedMap <V> unmodifiable(final Int2ObjectSortedMap <? extends V> m) { return new UnmodifiableSortedMap <>(m); }
}
