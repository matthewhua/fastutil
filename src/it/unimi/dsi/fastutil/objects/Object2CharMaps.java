...
public final class Object2CharMaps {
	...
	public static <K> ObjectIterable<Object2CharMap.Entry <K> > fastIterable(Object2CharMap <K> map) {
	 ...
	 return entries instanceof Object2CharMap.FastEntrySet ? new ObjectIterable<Object2CharMap.Entry <K> >() {
	  ...
	  @Override
	  public ObjectSpliterator<Object2CharMap.Entry <K> > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class SynchronizedMap <K> extends Object2CharFunctions.SynchronizedFunction <K> implements Object2CharMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public char computeIfAbsent(final K key, final Object2CharFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap <K> extends Object2CharFunctions.UnmodifiableFunction <K> implements Object2CharMap <K>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Object2CharMap.Entry <K> > object2CharEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2CharEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public char getOrDefault(final Object key, final char defaultValue) { return ((Object2CharMap <K>)map).getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 @Override
	 public char computeIfAbsent(final K key, final Object2CharFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public Character getOrDefault(final Object key, final Character defaultValue) { return ((Object2CharMap <K>)map).getOrDefault(key, defaultValue); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <K> Object2CharMap <K> unmodifiable(final Object2CharMap <? extends K> m) { return new UnmodifiableMap <>(m); }
}
