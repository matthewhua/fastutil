...
public final class Reference2LongMaps {
	...
	public static <K> ObjectIterable<Reference2LongMap.Entry <K> > fastIterable(Reference2LongMap <K> map) {
	 ...
	 return entries instanceof Reference2LongMap.FastEntrySet ? new ObjectIterable<Reference2LongMap.Entry <K> >() {
	  ...
	  @Override
	  public ObjectSpliterator<Reference2LongMap.Entry <K> > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class SynchronizedMap <K> extends Reference2LongFunctions.SynchronizedFunction <K> implements Reference2LongMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public long computeIfAbsent(final K key, final java.util.function.ToLongFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	 public long computeIfAbsent(final K key, final Reference2LongFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap <K> extends Reference2LongFunctions.UnmodifiableFunction <K> implements Reference2LongMap <K>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Reference2LongMap.Entry <K> > reference2LongEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.reference2LongEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public long getOrDefault(final Object key, final long defaultValue) { return ((Reference2LongMap <K>)map).getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 @Override
	 public long computeIfAbsent(final K key, final java.util.function.ToLongFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
	 public long computeIfAbsent(final K key, final Reference2LongFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 */
	public static <K> Reference2LongMap <K> unmodifiable(final Reference2LongMap <? extends K> m) { return new UnmodifiableMap <>(m); }
}
