	...
	public ObjectSortedSet<Float2ByteMap.Entry > float2ByteEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Float2ByteMap.Entry >() {
	   final Comparator<? super Float2ByteMap.Entry > comparator = (Float2ByteAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Float2ByteMap.Entry >) (x, y) -> ( Float.compare((x.getFloatKey()),(y.getFloatKey())) ) :
	    (Comparator<Float2ByteMap.Entry >) (x, y) -> Float2ByteAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey())
	   );
	   @Override
