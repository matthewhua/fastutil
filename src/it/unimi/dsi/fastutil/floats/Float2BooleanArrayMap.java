...
public class Float2BooleanArrayMap extends AbstractFloat2BooleanMap implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Float2BooleanMap.Entry > implements FastEntrySet {
	 ...
	 final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Float2BooleanMap.Entry >
	...
	private final class KeySet extends AbstractFloatSet {
	 ...
	 final class KeySetSpliterator extends FloatSpliterators.EarlyBindingSizeIndexBasedSpliterator
	  ...
	  protected final float get(int location) { return key[location]; }
	  @Override
