...
public final class Long2ObjectFunctions {
	...
	public static class UnmodifiableFunction <V> extends AbstractLong2ObjectFunction <V> implements java.io.Serializable {
	 ...
	 public V getOrDefault(final long k, final V defaultValue) { return ((Long2ObjectFunction <V>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public V getOrDefault(final Object k, final V defaultValue) { return ((Long2ObjectFunction <V>)function).getOrDefault(k, defaultValue); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <V> Long2ObjectFunction <V> unmodifiable(final Long2ObjectFunction <? extends V> f) { return new UnmodifiableFunction <>(f); }
