...
public final class Long2FloatFunctions {
	...
	public static class EmptyFunction extends AbstractLong2FloatFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public float getOrDefault(final long k, final float defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractLong2FloatFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public float getOrDefault(final long k, final float defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Long2FloatFunction , java.io.Serializable {
	 ...
	 @Override
	 public float getOrDefault(final long k, final float defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractLong2FloatFunction implements java.io.Serializable {
	 ...
	 @Override
	 public float getOrDefault(final long k, final float defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
