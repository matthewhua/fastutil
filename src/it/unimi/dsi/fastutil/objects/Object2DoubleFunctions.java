...
public final class Object2DoubleFunctions {
	...
	public static class EmptyFunction <K> extends AbstractObject2DoubleFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public double getOrDefault(final Object k, final double defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton <K> extends AbstractObject2DoubleFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public double getOrDefault(final Object k, final double defaultValue) { return java.util.Objects.equals(key, k) ? value : defaultValue; }
	 @Override
	...
	public static class UnmodifiableFunction <K> extends AbstractObject2DoubleFunction <K> implements java.io.Serializable {
	 ...
	 public double getOrDefault(final Object k, final double defaultValue) { return ((Object2DoubleFunction <K>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 */
	public static <K> Object2DoubleFunction <K> unmodifiable(final Object2DoubleFunction <? extends K> f) { return new UnmodifiableFunction <>(f); }
