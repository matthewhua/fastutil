...
public abstract class AbstractReferenceBigList <K> extends AbstractReferenceCollection <K> implements ReferenceBigList <K>, Stack <K> {
	...
	public ObjectBigListIterator <K> listIterator(final long index) {
	 ...
	 return new ObjectBigListIterators.AbstractIndexBasedBigListIterator <K>(0, index) {
	  @Override
	  protected final K get(long i) { return AbstractReferenceBigList.this.get(i); }
	  @Override
	  protected final void add(long i, K k) { AbstractReferenceBigList.this.add(i, k); }
	  @Override
	  protected final void set(long i, K k) { AbstractReferenceBigList.this.set(i, k); }
	  @Override
	  protected final void remove(long i) { AbstractReferenceBigList.this.remove(i); }
	  @Override
	  protected final long getMaxPos() { return AbstractReferenceBigList.this.size64(); }
	 };
	}
	...
	public static class ReferenceSubList <K> extends AbstractReferenceBigList <K> implements java.io.Serializable {
	 ...
	 private final class RandomAccessIter extends ObjectBigListIterators.AbstractIndexBasedBigListIterator <K> {
	  ...
	  @Override
	  protected final void add(long i, K k) { ReferenceSubList.this.add(i, k); }
	  @Override
	  protected final void set(long i, K k) { ReferenceSubList.this.set(i, k); }
	  @Override
	  protected final void remove(long i) { ReferenceSubList.this.remove(i); }
	  @Override
