...
public final class Reference2ReferenceSortedMaps {
	...
	public static class UnmodifiableSortedMap <K,V> extends Reference2ReferenceMaps.UnmodifiableMap <K,V> implements Reference2ReferenceSortedMap <K,V>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "rawtypes", "unchecked" })
	 @Override
	 public ObjectSortedSet<Reference2ReferenceMap.Entry <K,V> > reference2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.reference2ReferenceEntrySet()); return (ObjectSortedSet<Reference2ReferenceMap.Entry <K,V> >)entries; }
	 /** {@inheritDoc} */
	 @Override
	 @SuppressWarnings({ "rawtypes", "unchecked" })
	 public ObjectSortedSet<Map.Entry<K, V>> entrySet() { return (ObjectSortedSet)reference2ReferenceEntrySet(); }
	 ...
	 */
	public static <K,V> Reference2ReferenceSortedMap <K,V> unmodifiable(final Reference2ReferenceSortedMap <K, ? extends V> m) { return new UnmodifiableSortedMap <>(m); }
}
