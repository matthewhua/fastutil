...
public final class ReferenceCollections {
	...
	public abstract static class EmptyCollection <K> extends AbstractReferenceCollection <K> {
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public ObjectSpliterator <K> spliterator() { return ObjectSpliterators.EMPTY_SPLITERATOR; }
	 @Override
	...
	static class SynchronizedCollection <K> implements ReferenceCollection <K>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSpliterator <K> spliterator() { return collection.spliterator(); }
	 @Override
	 public java.util.stream.Stream <K> stream() { return collection.stream(); }
	 @Override
	 public java.util.stream.Stream <K> parallelStream() { return collection.parallelStream(); }
	 @Override
	 public void forEach(final Consumer <? super K> action) { synchronized(sync) { collection.forEach(action); } }
	 @Override
	 ...
	 @Override
	 public boolean removeIf(final Predicate <? super K> filter) { synchronized(sync) { return collection.removeIf(filter); } }
	 @Override
	...
	static class UnmodifiableCollection <K> implements ReferenceCollection <K>, java.io.Serializable {
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public ObjectSpliterator <K> spliterator() { return (ObjectSpliterator <K>)collection.spliterator(); }
	 @Override
	 @SuppressWarnings("unchecked")
	 public java.util.stream.Stream <K> stream() { return (java.util.stream.Stream <K>)collection.stream(); }
	 @Override
	 @SuppressWarnings("unchecked")
	 public java.util.stream.Stream <K> parallelStream() { return (java.util.stream.Stream <K>)collection.parallelStream(); }
	 @Override
	 ...
	 @Override
	 public void forEach(final Consumer <? super K> action) { collection.forEach(action); }
	 @Override
	 ...
	 @Override
	 public boolean removeIf(final Predicate <? super K> filter) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 */
	public static <K> ReferenceCollection <K> unmodifiable(final ReferenceCollection <? extends K> c) { return new UnmodifiableCollection <>(c); }
	...
	public static class IterableCollection <K> extends AbstractReferenceCollection <K> implements java.io.Serializable {
	 ...
	 @Override
	 public ObjectSpliterator <K> spliterator() { return iterable.spliterator(); }
	}
	...
	static class SizeDecreasingSupplier<
	  K,
	  C extends ReferenceCollection <K> > implements Supplier<C> {
