...
public final class Float2ShortFunctions {
	...
	public static class EmptyFunction extends AbstractFloat2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short getOrDefault(final float k, final short defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractFloat2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short getOrDefault(final float k, final short defaultValue) { return ( Float.floatToIntBits(key) == Float.floatToIntBits(k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Float2ShortFunction , java.io.Serializable {
	 ...
	 @Override
	 public short getOrDefault(final float k, final short defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractFloat2ShortFunction implements java.io.Serializable {
	 ...
	 @Override
	 public short getOrDefault(final float k, final short defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
