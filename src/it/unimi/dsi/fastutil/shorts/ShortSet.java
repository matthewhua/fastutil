...
public interface ShortSet extends ShortCollection , Set<Short> {
	...
	default ShortSpliterator spliterator() {
	 return ShortSpliterators.asSpliterator(
	   iterator(), sizeOf(this), ShortSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
	}
	...
	public static ShortSet of(short... a) {
	 ...
	 ShortSet innerSet = a.length <= ShortSets.ARRAY_SET_CUTOFF ?
	  new ShortArraySet (a.length) :
	  new ShortOpenHashSet (a.length);
	 for (short element : a) {
