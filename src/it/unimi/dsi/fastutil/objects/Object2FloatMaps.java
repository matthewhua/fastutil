...
public final class Object2FloatMaps {
	...
	public static <K> ObjectIterable<Object2FloatMap.Entry <K> > fastIterable(Object2FloatMap <K> map) {
	 ...
	 return entries instanceof Object2FloatMap.FastEntrySet ? new ObjectIterable<Object2FloatMap.Entry <K> >() {
	  ...
	  @Override
	  public ObjectSpliterator<Object2FloatMap.Entry <K> > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class SynchronizedMap <K> extends Object2FloatFunctions.SynchronizedFunction <K> implements Object2FloatMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public float computeIfAbsent(final K key, final Object2FloatFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap <K> extends Object2FloatFunctions.UnmodifiableFunction <K> implements Object2FloatMap <K>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Object2FloatMap.Entry <K> > object2FloatEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2FloatEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public float getOrDefault(final Object key, final float defaultValue) { return ((Object2FloatMap <K>)map).getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 @Override
	 public float computeIfAbsent(final K key, final Object2FloatFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 */
	public static <K> Object2FloatMap <K> unmodifiable(final Object2FloatMap <? extends K> m) { return new UnmodifiableMap <>(m); }
}
