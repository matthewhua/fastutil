...
public final class Short2BooleanFunctions {
	...
	public static class EmptyFunction extends AbstractShort2BooleanFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean getOrDefault(final short k, final boolean defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractShort2BooleanFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean getOrDefault(final short k, final boolean defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Short2BooleanFunction , java.io.Serializable {
	 ...
	 @Override
	 public boolean getOrDefault(final short k, final boolean defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractShort2BooleanFunction implements java.io.Serializable {
	 ...
	 @Override
	 public boolean getOrDefault(final short k, final boolean defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
