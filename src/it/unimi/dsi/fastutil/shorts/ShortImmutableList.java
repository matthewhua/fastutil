...
public class ShortImmutableList extends ShortLists.ImmutableListBase implements ShortList , RandomAccess, Cloneable, java.io.Serializable {
	...
	public ShortListIterator listIterator(final int index) {
	 ...
	 return new ShortListIterator () {
	   ...
	   @Override
	   public short nextShort() { if (! hasNext()) throw new NoSuchElementException(); return a[pos++]; }
	   @Override
	   public short previousShort() { if (! hasPrevious()) throw new NoSuchElementException(); return a[--pos]; }
	   @Override
	 ...
	 @Override
	 public int characteristics() { return ShortSpliterators.LIST_SPLITERATOR_CHARACTERISTICS | java.util.Spliterator.IMMUTABLE; }
	 @Override
	...
	private final static class ImmutableSubList extends ShortLists.ImmutableListBase implements java.util.RandomAccess, java.io.Serializable {
	 ...
	 public ShortListIterator listIterator(final int index) {
	  ...
	  return new ShortListIterator () {
	    ...
	    @Override
	    public short nextShort() { if (! hasNext()) throw new NoSuchElementException(); return a[pos++ + from]; }
	    @Override
	    public short previousShort() { if (! hasPrevious()) throw new NoSuchElementException(); return a[--pos + from]; }
	    @Override
	    public int nextIndex() { return pos; }
	    @Override
	    public int previousIndex() { return pos - 1; }
