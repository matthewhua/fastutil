...
public final class LongLists {
	...
	public static class EmptyList extends LongCollections.EmptyCollection implements LongList , RandomAccess, java.io.Serializable, Cloneable {
	 ...
	 @Deprecated
	 @Override
	 public void replaceAll(final java.util.function.UnaryOperator<Long> operator) { throw new UnsupportedOperationException(); }
	 @Override
	 public void replaceAll(final java.util.function.LongUnaryOperator operator) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 @Override
	 public void setElements(final long a[]) { throw new UnsupportedOperationException(); }
	 @Override
	 public void setElements(int index, final long a[]) { throw new UnsupportedOperationException(); }
	 @Override
	 public void setElements(int index, final long a[], int offset, int length) { throw new UnsupportedOperationException(); }
	 @Override
	...
	public static class Singleton extends AbstractLongList implements RandomAccess, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int indexOf(final long k) { return ( (k) == (element) ) ? 0 : -1; }
	 ...
	 public void removeElements(int from, int to) { throw new UnsupportedOperationException(); }
	 @Override
	 public void addElements(int index, long a[]) { throw new UnsupportedOperationException(); }
	 @Override
	 public void addElements(int index, long a[], int offset, int length) { throw new UnsupportedOperationException(); }
	 @Override
	 public void setElements(final long a[]) { throw new UnsupportedOperationException(); }
	 @Override
	 public void setElements(int index, final long a[]) { throw new UnsupportedOperationException(); }
	...
	public static class SynchronizedList extends LongCollections.SynchronizedCollection implements LongList , java.io.Serializable {
	 ...
	 @Override
	 public boolean removeIf(final java.util.function.LongPredicate filter) { synchronized(sync) { return list.removeIf(filter); } }
	 @Override
	 public void replaceAll(final java.util.function.LongUnaryOperator operator) { synchronized(sync) { list.replaceAll(operator); } }
	 @Override
	 ...
	 @Override
	 public void setElements(final long a[]) { synchronized(sync) { list.setElements(a); } }
	 @Override
	 public void setElements(int index, final long a[]) { synchronized(sync) { list.setElements(index, a); } }
	 @Override
	 public void setElements(int index, final long a[], int offset, int length) { synchronized(sync) { list.setElements(index, a, offset, length); } }
	 @Override
	 ...
	 @Override
	 public void sort(final LongComparator comparator) { synchronized(sync) { list.sort(comparator); } }
	 @Override
	 public void unstableSort(final LongComparator comparator) { synchronized(sync) { list.unstableSort(comparator); } }
	 @Deprecated
	 @Override
	 public void sort(final java.util.Comparator<? super Long> comparator) { synchronized(sync) {list.sort(comparator); } }
	 @Deprecated
	 @Override
	 public void unstableSort(final java.util.Comparator<? super Long> comparator) { synchronized(sync) {list.unstableSort(comparator); } }
	...
	public static class UnmodifiableList extends LongCollections.UnmodifiableCollection implements LongList , java.io.Serializable {
	 ...
	 @Override
	 public void sort(final LongComparator comparator) { throw new UnsupportedOperationException(); }
	 @Override
	 public void unstableSort(final LongComparator comparator) { throw new UnsupportedOperationException(); }
	 @Deprecated
	 @Override
	 public void sort(final java.util.Comparator<? super Long> comparator) { throw new UnsupportedOperationException(); }
	 @Deprecated
	 @Override
	 public void unstableSort(final java.util.Comparator<? super Long> comparator) { throw new UnsupportedOperationException(); }
	}
