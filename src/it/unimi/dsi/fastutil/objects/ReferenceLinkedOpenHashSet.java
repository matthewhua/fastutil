...
public class ReferenceLinkedOpenHashSet <K> extends AbstractReferenceSortedSet <K> implements java.io.Serializable, Cloneable, Hash {
	...
	private static final Collector<Object, ?, ReferenceLinkedOpenHashSet<Object>> TO_SET_COLLECTOR =
	 Collector.of(
	...
	public static <K> Collector<K, ?, ReferenceLinkedOpenHashSet <K> > toSetWithExpectedSize(int expectedSize) {
	 ...
	 return Collector.of(
	  ...
	  expectedSize, (int size) ->
	   size <= Hash.DEFAULT_INITIAL_SIZE ? new ReferenceLinkedOpenHashSet <K>() : new ReferenceLinkedOpenHashSet <K>(size)),
	 ReferenceLinkedOpenHashSet::add,
	 ReferenceLinkedOpenHashSet::combine
	 );
	}
