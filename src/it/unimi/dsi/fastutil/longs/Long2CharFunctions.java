...
public final class Long2CharFunctions {
	...
	public static class EmptyFunction extends AbstractLong2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char getOrDefault(final long k, final char defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractLong2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char getOrDefault(final long k, final char defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Long2CharFunction , java.io.Serializable {
	 ...
	 @Override
	 public char getOrDefault(final long k, final char defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractLong2CharFunction implements java.io.Serializable {
	 ...
	 @Override
	 public char getOrDefault(final long k, final char defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
