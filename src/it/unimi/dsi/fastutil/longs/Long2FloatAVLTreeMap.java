	...
	public ObjectSortedSet<Long2FloatMap.Entry > long2FloatEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2FloatMap.Entry >() {
	   final Comparator<? super Long2FloatMap.Entry > comparator = (Long2FloatAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Long2FloatMap.Entry >) (x, y) -> ( Long.compare((x.getLongKey()),(y.getLongKey())) ) :
	    (Comparator<Long2FloatMap.Entry >) (x, y) -> Long2FloatAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey())
	   );
	   @Override
