...
public final class Reference2BooleanMaps {
	...
	public static <K> ObjectIterable<Reference2BooleanMap.Entry <K> > fastIterable(Reference2BooleanMap <K> map) {
	 ...
	 return entries instanceof Reference2BooleanMap.FastEntrySet ? new ObjectIterable<Reference2BooleanMap.Entry <K> >() {
	  ...
	  @Override
	  public ObjectSpliterator<Reference2BooleanMap.Entry <K> > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class SynchronizedMap <K> extends Reference2BooleanFunctions.SynchronizedFunction <K> implements Reference2BooleanMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public boolean computeIfAbsent(final K key, final java.util.function.Predicate <? super K> mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	 public boolean computeIfAbsent(final K key, final Reference2BooleanFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap <K> extends Reference2BooleanFunctions.UnmodifiableFunction <K> implements Reference2BooleanMap <K>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Reference2BooleanMap.Entry <K> > reference2BooleanEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.reference2BooleanEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public boolean getOrDefault(final Object key, final boolean defaultValue) { return ((Reference2BooleanMap <K>)map).getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 @Override
	 public boolean computeIfAbsent(final K key, final java.util.function.Predicate <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
	 public boolean computeIfAbsent(final K key, final Reference2BooleanFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 */
	public static <K> Reference2BooleanMap <K> unmodifiable(final Reference2BooleanMap <? extends K> m) { return new UnmodifiableMap <>(m); }
}
