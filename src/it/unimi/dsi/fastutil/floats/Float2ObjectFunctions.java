...
public final class Float2ObjectFunctions {
	...
	public static class UnmodifiableFunction <V> extends AbstractFloat2ObjectFunction <V> implements java.io.Serializable {
	 ...
	 public V getOrDefault(final float k, final V defaultValue) { return ((Float2ObjectFunction <V>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public V getOrDefault(final Object k, final V defaultValue) { return ((Float2ObjectFunction <V>)function).getOrDefault(k, defaultValue); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <V> Float2ObjectFunction <V> unmodifiable(final Float2ObjectFunction <? extends V> f) { return new UnmodifiableFunction <>(f); }
