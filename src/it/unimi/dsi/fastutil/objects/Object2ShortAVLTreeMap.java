	...
	public ObjectSortedSet<Object2ShortMap.Entry <K> > object2ShortEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2ShortMap.Entry <K> >() {
	   final Comparator<? super Object2ShortMap.Entry <K> > comparator = (Object2ShortAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Object2ShortMap.Entry <K> >) (x, y) -> ( ((Comparable<K>)(x.getKey())).compareTo(y.getKey()) ) :
	    (Comparator<Object2ShortMap.Entry <K> >) (x, y) -> Object2ShortAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey())
	   );
	   @Override
