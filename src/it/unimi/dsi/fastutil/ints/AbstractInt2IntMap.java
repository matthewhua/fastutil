...
public abstract class AbstractInt2IntMap extends AbstractInt2IntFunction implements Int2IntMap , java.io.Serializable {
	 ...
	 return new AbstractIntSet () {
	   ...
	   public IntSpliterator spliterator() {
	    return IntSpliterators.asSpliterator(
	     iterator(), sizeOf(AbstractInt2IntMap.this), IntSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
	   }
	  };
	}
	...
	public IntCollection values() {
	 return new AbstractIntCollection () {
	   ...
	   public IntSpliterator spliterator() {
	    return IntSpliterators.asSpliterator(
	     iterator(), sizeOf(AbstractInt2IntMap.this), IntSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
	   }
	  };
	}
	/** {@inheritDoc} */
