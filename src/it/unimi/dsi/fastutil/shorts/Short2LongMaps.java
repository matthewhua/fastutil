...
public final class Short2LongMaps {
	...
	public static ObjectIterable<Short2LongMap.Entry > fastIterable(Short2LongMap map) {
	 ...
	 return entries instanceof Short2LongMap.FastEntrySet ? new ObjectIterable<Short2LongMap.Entry >() {
	  ...
	  @Override
	  public ObjectSpliterator<Short2LongMap.Entry > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class EmptyMap extends Short2LongFunctions.EmptyFunction implements Short2LongMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long getOrDefault(final short key, final long defaultValue) { return defaultValue; }
	 /** {@inheritDoc}
	...
	public static class SynchronizedMap extends Short2LongFunctions.SynchronizedFunction implements Short2LongMap , java.io.Serializable {
	 ...
	 @Override
	 public long computeIfAbsent(final short key, final Short2LongFunction mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap extends Short2LongFunctions.UnmodifiableFunction implements Short2LongMap , java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Short2LongMap.Entry > short2LongEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.short2LongEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 @Override
	 public long computeIfAbsent(final short key, final Short2LongFunction mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
