...
public final class FloatBigLists {
	...
	public static class EmptyBigList extends FloatCollections.EmptyCollection implements FloatBigList , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public void getElements(long from, float[][] a, long offset, long length) { BigArrays.ensureOffsetLength(a, offset, length); if (from != 0) throw new IndexOutOfBoundsException(); }
	 @Override
	...
	public static class Singleton extends AbstractFloatBigList implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long indexOf(final float k) { return ( Float.floatToIntBits(k) == Float.floatToIntBits(element) ) ? 0 : -1; }
