	...
	public ObjectSortedSet<Int2CharMap.Entry > int2CharEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Int2CharMap.Entry >() {
	   final Comparator<? super Int2CharMap.Entry > comparator = (Int2CharAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Int2CharMap.Entry >) (x, y) -> ( Integer.compare((x.getIntKey()),(y.getIntKey())) ) :
	    (Comparator<Int2CharMap.Entry >) (x, y) -> Int2CharAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey())
	   );
	   @Override
