...
public final class FloatLists {
	...
	public static class EmptyList extends FloatCollections.EmptyCollection implements FloatList , RandomAccess, java.io.Serializable, Cloneable {
	 ...
	 @Deprecated
	 @Override
	 public void replaceAll(final java.util.function.UnaryOperator<Float> operator) { throw new UnsupportedOperationException(); }
	 @Override
	 public void replaceAll(final FloatUnaryOperator operator) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 @Override
	 public void setElements(final float a[]) { throw new UnsupportedOperationException(); }
	 @Override
	 public void setElements(int index, final float a[]) { throw new UnsupportedOperationException(); }
	 @Override
	 public void setElements(int index, final float a[], int offset, int length) { throw new UnsupportedOperationException(); }
	 @Override
	...
	public static class Singleton extends AbstractFloatList implements RandomAccess, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int indexOf(final float k) { return ( Float.floatToIntBits(k) == Float.floatToIntBits(element) ) ? 0 : -1; }
	 /* Slightly optimized w.r.t. the one in ABSTRACT_SET. */
	 @Override
	 public float[] toFloatArray() { return new float[]{element}; }
	 @Override
	 ...
	 @Override
	 public FloatSpliterator spliterator() { return FloatSpliterators.singleton(element); }
	 @Override
	 ...
	 @Deprecated
	 @Override
	 public void forEach(final Consumer<? super Float> action) { action.accept(Float.valueOf(element)); }
	 @Override
	 public boolean addAll(int i, Collection<? extends Float> c) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 @Deprecated
	 @Override
	 public boolean removeIf(final java.util.function.Predicate<? super Float> filter) { throw new UnsupportedOperationException(); }
	 @Deprecated
	 @Override
	 public void replaceAll(final java.util.function.UnaryOperator<Float> operator) { throw new UnsupportedOperationException(); }
	 @Override
	 public void replaceAll(final FloatUnaryOperator operator) { throw new UnsupportedOperationException(); }
	 @Override
	 public void forEach(final FloatConsumer action) { action.accept(element); }
	 @Override
	 public boolean addAll(FloatList c) { throw new UnsupportedOperationException(); }
	 @Override
	 public boolean addAll(int i, FloatList c) { throw new UnsupportedOperationException(); }
	 ...
	 @Override
	 public boolean removeIf(final FloatPredicate filter) { throw new UnsupportedOperationException(); }
	 @Override
	 public DoubleIterator doubleIterator() { return DoubleIterators.singleton(element); }
	 @Override
	 public DoubleSpliterator doubleSpliterator() { return DoubleSpliterators.singleton(element); }
	 @Deprecated
	 @Override
	 public Object[] toArray() { return new Object[]{ Float.valueOf(element) }; }
	 ...
	 public void removeElements(int from, int to) { throw new UnsupportedOperationException(); }
	 @Override
	 public void addElements(int index, float a[]) { throw new UnsupportedOperationException(); }
	 @Override
	 public void addElements(int index, float a[], int offset, int length) { throw new UnsupportedOperationException(); }
	 @Override
	 public void setElements(final float a[]) { throw new UnsupportedOperationException(); }
	 @Override
	 public void setElements(int index, final float a[]) { throw new UnsupportedOperationException(); }
	...
	public static class SynchronizedList extends FloatCollections.SynchronizedCollection implements FloatList , java.io.Serializable {
	 ...
	 @Override
	 public boolean removeIf(final FloatPredicate filter) { synchronized(sync) { return list.removeIf(filter); } }
	 @Override
	 public void replaceAll(final FloatUnaryOperator operator) { synchronized(sync) { list.replaceAll(operator); } }
	 @Override
	 ...
	 @Override
	 public void setElements(final float a[]) { synchronized(sync) { list.setElements(a); } }
	 @Override
	 public void setElements(int index, final float a[]) { synchronized(sync) { list.setElements(index, a); } }
	 @Override
	 public void setElements(int index, final float a[], int offset, int length) { synchronized(sync) { list.setElements(index, a, offset, length); } }
	 @Override
	 ...
	 @Override
	 public void sort(final FloatComparator comparator) { synchronized(sync) { list.sort(comparator); } }
	 @Override
	 public void unstableSort(final FloatComparator comparator) { synchronized(sync) { list.unstableSort(comparator); } }
	 @Deprecated
	 @Override
	 public void sort(final java.util.Comparator<? super Float> comparator) { synchronized(sync) {list.sort(comparator); } }
	 @Deprecated
	 @Override
	 public void unstableSort(final java.util.Comparator<? super Float> comparator) { synchronized(sync) {list.unstableSort(comparator); } }
	...
	public static class UnmodifiableList extends FloatCollections.UnmodifiableCollection implements FloatList , java.io.Serializable {
	 ...
	 @Override
	 public void sort(final FloatComparator comparator) { throw new UnsupportedOperationException(); }
	 @Override
	 public void unstableSort(final FloatComparator comparator) { throw new UnsupportedOperationException(); }
	 @Deprecated
	 @Override
	 public void sort(final java.util.Comparator<? super Float> comparator) { throw new UnsupportedOperationException(); }
	 @Deprecated
	 @Override
	 public void unstableSort(final java.util.Comparator<? super Float> comparator) { throw new UnsupportedOperationException(); }
	}
