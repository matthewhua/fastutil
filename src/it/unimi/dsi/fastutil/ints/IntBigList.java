...
public interface IntBigList extends BigList<Integer>, IntCollection , Comparable<BigList<? extends Integer>> {
	...
	default IntSpliterator spliterator() {
	 return IntSpliterators.asSpliterator(
	   iterator(), size64(), IntSpliterators.LIST_SPLITERATOR_CHARACTERISTICS);
	}
	 ...
	 */
	default boolean addAll(final long index, final IntBigList l) { return addAll(index, (IntCollection ) l); }
	 ...
	 */
	default boolean addAll(final IntBigList l) { return addAll(size64(), l); }
	 ...
	 * @see BigList#addAll(long,Collection)
	 */
	default boolean addAll(final long index, final IntList l) { return addAll(index, (IntCollection ) l); }
	 ...
	 * @see BigList#addAll(Collection)
	 */
	default boolean addAll(final IntList l) { return addAll(size64(), l); }
