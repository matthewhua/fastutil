...
public class Long2BooleanArrayMap extends AbstractLong2BooleanMap implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Long2BooleanMap.Entry > implements FastEntrySet {
	 ...
	 final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Long2BooleanMap.Entry >
	...
	private final class KeySet extends AbstractLongSet {
	 ...
	 final class KeySetSpliterator extends LongSpliterators.EarlyBindingSizeIndexBasedSpliterator
	  ...
	  protected final long get(int location) { return key[location]; }
	  @Override
