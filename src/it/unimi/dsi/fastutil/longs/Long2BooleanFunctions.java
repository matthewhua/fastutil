...
public final class Long2BooleanFunctions {
	...
	public static class EmptyFunction extends AbstractLong2BooleanFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean getOrDefault(final long k, final boolean defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractLong2BooleanFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean getOrDefault(final long k, final boolean defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Long2BooleanFunction , java.io.Serializable {
	 ...
	 @Override
	 public boolean getOrDefault(final long k, final boolean defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractLong2BooleanFunction implements java.io.Serializable {
	 ...
	 @Override
	 public boolean getOrDefault(final long k, final boolean defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
