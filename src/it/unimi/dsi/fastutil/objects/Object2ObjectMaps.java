...
public final class Object2ObjectMaps {
	...
	public static <K,V> ObjectIterable<Object2ObjectMap.Entry <K,V> > fastIterable(Object2ObjectMap <K,V> map) {
	 ...
	 return entries instanceof Object2ObjectMap.FastEntrySet ? new ObjectIterable<Object2ObjectMap.Entry <K,V> >() {
	  ...
	  @Override
	  public ObjectSpliterator<Object2ObjectMap.Entry <K,V> > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class UnmodifiableMap <K,V> extends Object2ObjectFunctions.UnmodifiableFunction <K,V> implements Object2ObjectMap <K,V>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Object2ObjectMap.Entry <K,V> > object2ObjectEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2ObjectEntrySet()); return entries; }
	 /** {@inheritDoc} */
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Map.Entry<K, V>> entrySet() { return (ObjectSet)object2ObjectEntrySet(); }
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public V getOrDefault(final Object key, final V defaultValue) { return ((Object2ObjectMap <K,V>)map).getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 */
	public static <K,V> Object2ObjectMap <K,V> unmodifiable(final Object2ObjectMap <? extends K, ? extends V> m) { return new UnmodifiableMap <>(m); }
}
