...
public final class Object2ShortSortedMaps {
	...
	public static class UnmodifiableSortedMap <K> extends Object2ShortMaps.UnmodifiableMap <K> implements Object2ShortSortedMap <K>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "rawtypes", "unchecked" })
	 @Override
	 public ObjectSortedSet<Object2ShortMap.Entry <K> > object2ShortEntrySet() { if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.object2ShortEntrySet()); return (ObjectSortedSet<Object2ShortMap.Entry <K> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
