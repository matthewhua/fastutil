...
public final class DoubleCollections {
	...
	public abstract static class EmptyCollection extends AbstractDoubleCollection {
	 ...
	 public DoubleSpliterator spliterator() { return DoubleSpliterators.EMPTY_SPLITERATOR; }
	 @Override
	 ...
	 @Override
	 public boolean containsAll(final DoubleCollection c) { return c.isEmpty(); }
	 @Override
	...
	static class SynchronizedCollection implements DoubleCollection , java.io.Serializable {
	 ...
	 @Override
	 public DoubleSpliterator spliterator() { return collection.spliterator(); }
	 @Deprecated
	 @Override
	 public java.util.stream.Stream <Double> stream() { return collection.stream(); }
	 @Deprecated
	 @Override
	 public java.util.stream.Stream <Double> parallelStream() { return collection.parallelStream(); }
	 @Override
	 public void forEach(final java.util.function.DoubleConsumer action) { synchronized(sync) { collection.forEach(action); } }
	 @Override
	...
	static class UnmodifiableCollection implements DoubleCollection , java.io.Serializable {
	 ...
	 @Override
	 public void forEach(final java.util.function.DoubleConsumer action) { collection.forEach(action); }
	 @Override
	...
	public static class IterableCollection extends AbstractDoubleCollection implements java.io.Serializable {
	 ...
	 @Override
	 public DoubleSpliterator spliterator() { return iterable.spliterator(); }
	 @Override
	...
	static class SizeDecreasingSupplier<
	  C extends DoubleCollection > implements Supplier<C> {
