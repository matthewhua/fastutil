...
public final class Reference2FloatFunctions {
	...
	public static class Singleton <K> extends AbstractReference2FloatFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public float getOrDefault(final Object k, final float defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class UnmodifiableFunction <K> extends AbstractReference2FloatFunction <K> implements java.io.Serializable {
	 ...
	 public float getOrDefault(final Object k, final float defaultValue) { return ((Reference2FloatFunction <K>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 */
	public static <K> Reference2FloatFunction <K> unmodifiable(final Reference2FloatFunction <? extends K> f) { return new UnmodifiableFunction <>(f); }
