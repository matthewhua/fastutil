...
public interface FloatCollection extends Collection<Float>, FloatIterable {
	...
	@Deprecated
	@Override
	default java.util.stream.Stream<Float> stream() { return Collection.super.stream(); }
	...
	@Deprecated
	@Override
	default java.util.stream.Stream<Float> parallelStream() { return Collection.super.parallelStream(); }
