...
default it.unimi.dsi.fastutil.objects.Object2ByteFunction <K> andThenByte(it.unimi.dsi.fastutil.ints.Int2ByteFunction after) { return k -> after.get(getInt(k)); } default it.unimi.dsi.fastutil.bytes.Byte2IntFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2ObjectFunction <K> before) { return k -> getInt(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Object2ShortFunction <K> andThenShort(it.unimi.dsi.fastutil.ints.Int2ShortFunction after) { return k -> after.get(getInt(k)); } default it.unimi.dsi.fastutil.shorts.Short2IntFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2ObjectFunction <K> before) { return k -> getInt(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Object2IntFunction <K> andThenInt(it.unimi.dsi.fastutil.ints.Int2IntFunction after) { return k -> after.get(getInt(k)); } default it.unimi.dsi.fastutil.ints.Int2IntFunction composeInt(it.unimi.dsi.fastutil.ints.Int2ObjectFunction <K> before) { return k -> getInt(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Object2LongFunction <K> andThenLong(it.unimi.dsi.fastutil.ints.Int2LongFunction after) { return k -> after.get(getInt(k)); } default it.unimi.dsi.fastutil.longs.Long2IntFunction composeLong(it.unimi.dsi.fastutil.longs.Long2ObjectFunction <K> before) { return k -> getInt(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Object2CharFunction <K> andThenChar(it.unimi.dsi.fastutil.ints.Int2CharFunction after) { return k -> after.get(getInt(k)); } default it.unimi.dsi.fastutil.chars.Char2IntFunction composeChar(it.unimi.dsi.fastutil.chars.Char2ObjectFunction <K> before) { return k -> getInt(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Object2FloatFunction <K> andThenFloat(it.unimi.dsi.fastutil.ints.Int2FloatFunction after) { return k -> after.get(getInt(k)); } default it.unimi.dsi.fastutil.floats.Float2IntFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2ObjectFunction <K> before) { return k -> getInt(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Object2DoubleFunction <K> andThenDouble(it.unimi.dsi.fastutil.ints.Int2DoubleFunction after) { return k -> after.get(getInt(k)); } default it.unimi.dsi.fastutil.doubles.Double2IntFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2ObjectFunction <K> before) { return k -> getInt(before.get(k)); }
default <T> it.unimi.dsi.fastutil.objects.Object2ObjectFunction <K, T> andThenObject(it.unimi.dsi.fastutil.ints.Int2ObjectFunction <? extends T> after) { return k -> after.get(getInt(k)); } default <T> it.unimi.dsi.fastutil.objects.Object2IntFunction <T> composeObject(it.unimi.dsi.fastutil.objects.Object2ObjectFunction <? super T, ? extends K> before) { return k -> getInt(before.get(k)); }
default <T> it.unimi.dsi.fastutil.objects.Object2ReferenceFunction <K, T> andThenReference(it.unimi.dsi.fastutil.ints.Int2ReferenceFunction <? extends T> after) { return k -> after.get(getInt(k)); } default <T> it.unimi.dsi.fastutil.objects.Reference2IntFunction <T> composeReference(it.unimi.dsi.fastutil.objects.Reference2ObjectFunction <? super T, ? extends K> before) { return k -> getInt(before.get(k)); }
}
