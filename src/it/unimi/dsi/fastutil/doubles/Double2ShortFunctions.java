...
public final class Double2ShortFunctions {
	...
	public static class EmptyFunction extends AbstractDouble2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short getOrDefault(final double k, final short defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractDouble2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short getOrDefault(final double k, final short defaultValue) { return ( Double.doubleToLongBits(key) == Double.doubleToLongBits(k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Double2ShortFunction , java.io.Serializable {
	 ...
	 @Override
	 public short getOrDefault(final double k, final short defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	 ...
	 @Deprecated
	 @Override
	 public Short getOrDefault(final Object k, final Short defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractDouble2ShortFunction implements java.io.Serializable {
	 ...
	 @Override
	 public short getOrDefault(final double k, final short defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 @Deprecated
	 @Override
	 public Short getOrDefault(final Object k, final Short defaultValue) { return function.getOrDefault(k, defaultValue); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
