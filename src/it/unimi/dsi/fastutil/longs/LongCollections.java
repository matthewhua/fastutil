...
public final class LongCollections {
	...
	public abstract static class EmptyCollection extends AbstractLongCollection {
	 ...
	 public LongSpliterator spliterator() { return LongSpliterators.EMPTY_SPLITERATOR; }
	 @Override
	 ...
	 @Override
	 public boolean containsAll(final LongCollection c) { return c.isEmpty(); }
	 @Override
	...
	static class SynchronizedCollection implements LongCollection , java.io.Serializable {
	 ...
	 @Override
	 public LongIterator longIterator() { return collection.longIterator(); }
	 @Override
	 public LongSpliterator longSpliterator() { return collection.longSpliterator(); }
	 @Override
	 public java.util.stream.LongStream longStream() { return collection.longStream(); }
	 @Override
	 public java.util.stream.LongStream longParallelStream() { return collection.longParallelStream(); }
	 @Override
	 ...
	 @Override
	 public LongSpliterator spliterator() { return collection.spliterator(); }
	 @Deprecated
	 @Override
	 public java.util.stream.Stream <Long> stream() { return collection.stream(); }
	 @Deprecated
	 @Override
	 public java.util.stream.Stream <Long> parallelStream() { return collection.parallelStream(); }
	 @Override
	 public void forEach(final java.util.function.LongConsumer action) { synchronized(sync) { collection.forEach(action); } }
	 @Override
	...
	static class UnmodifiableCollection implements LongCollection , java.io.Serializable {
	 ...
	 @Override
	 public void forEach(final java.util.function.LongConsumer action) { collection.forEach(action); }
	 @Override
	...
	public static class IterableCollection extends AbstractLongCollection implements java.io.Serializable {
	 ...
	 @Override
	 public LongSpliterator spliterator() { return iterable.spliterator(); }
	 @Override
	 public LongIterator longIterator() { return iterable.longIterator() ; }
	 @Override
	 public LongSpliterator longSpliterator() { return iterable.longSpliterator() ; }
	}
	...
	static class SizeDecreasingSupplier<
	  C extends LongCollection > implements Supplier<C> {
