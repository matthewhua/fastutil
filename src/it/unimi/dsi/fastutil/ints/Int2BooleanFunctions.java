...
public final class Int2BooleanFunctions {
	...
	public static class EmptyFunction extends AbstractInt2BooleanFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean getOrDefault(final int k, final boolean defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractInt2BooleanFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean getOrDefault(final int k, final boolean defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Int2BooleanFunction , java.io.Serializable {
	 ...
	 @Override
	 public boolean getOrDefault(final int k, final boolean defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractInt2BooleanFunction implements java.io.Serializable {
	 ...
	 @Override
	 public boolean getOrDefault(final int k, final boolean defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
