...
public final class Long2ReferenceFunctions {
	...
	public static class EmptyFunction <V> extends AbstractLong2ReferenceFunction <V> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public V getOrDefault(final long k, final V defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton <V> extends AbstractLong2ReferenceFunction <V> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public V getOrDefault(final long k, final V defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction <V> implements Long2ReferenceFunction <V>, java.io.Serializable {
	 ...
	 @Override
	 public V getOrDefault(final long k, final V defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction <V> extends AbstractLong2ReferenceFunction <V> implements java.io.Serializable {
	 ...
	 public V getOrDefault(final long k, final V defaultValue) { return ((Long2ReferenceFunction <V>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public V getOrDefault(final Object k, final V defaultValue) { return ((Long2ReferenceFunction <V>)function).getOrDefault(k, defaultValue); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <V> Long2ReferenceFunction <V> unmodifiable(final Long2ReferenceFunction <? extends V> f) { return new UnmodifiableFunction <>(f); }
