...
public final class Int2FloatFunctions {
	...
	public static class EmptyFunction extends AbstractInt2FloatFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public float getOrDefault(final int k, final float defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractInt2FloatFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public float getOrDefault(final int k, final float defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Int2FloatFunction , java.io.Serializable {
	 ...
	 @Override
	 public float getOrDefault(final int k, final float defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractInt2FloatFunction implements java.io.Serializable {
	 ...
	 @Override
	 public float getOrDefault(final int k, final float defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
