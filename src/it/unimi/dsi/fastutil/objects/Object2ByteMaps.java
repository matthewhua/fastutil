...
public final class Object2ByteMaps {
	...
	public static <K> ObjectIterable<Object2ByteMap.Entry <K> > fastIterable(Object2ByteMap <K> map) {
	 ...
	 return entries instanceof Object2ByteMap.FastEntrySet ? new ObjectIterable<Object2ByteMap.Entry <K> >() {
	  ...
	  @Override
	  public ObjectSpliterator<Object2ByteMap.Entry <K> > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class SynchronizedMap <K> extends Object2ByteFunctions.SynchronizedFunction <K> implements Object2ByteMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public byte computeIfAbsent(final K key, final Object2ByteFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap <K> extends Object2ByteFunctions.UnmodifiableFunction <K> implements Object2ByteMap <K>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Object2ByteMap.Entry <K> > object2ByteEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2ByteEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public byte getOrDefault(final Object key, final byte defaultValue) { return ((Object2ByteMap <K>)map).getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 @Override
	 public byte computeIfAbsent(final K key, final Object2ByteFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 */
	public static <K> Object2ByteMap <K> unmodifiable(final Object2ByteMap <? extends K> m) { return new UnmodifiableMap <>(m); }
}
