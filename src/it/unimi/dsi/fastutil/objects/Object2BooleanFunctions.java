...
public final class Object2BooleanFunctions {
	...
	public static class EmptyFunction <K> extends AbstractObject2BooleanFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean getOrDefault(final Object k, final boolean defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton <K> extends AbstractObject2BooleanFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean getOrDefault(final Object k, final boolean defaultValue) { return java.util.Objects.equals(key, k) ? value : defaultValue; }
	 @Override
	...
	public static class UnmodifiableFunction <K> extends AbstractObject2BooleanFunction <K> implements java.io.Serializable {
	 ...
	 public boolean getOrDefault(final Object k, final boolean defaultValue) { return ((Object2BooleanFunction <K>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 */
	public static <K> Object2BooleanFunction <K> unmodifiable(final Object2BooleanFunction <? extends K> f) { return new UnmodifiableFunction <>(f); }
