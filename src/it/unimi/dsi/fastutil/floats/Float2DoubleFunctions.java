...
public final class Float2DoubleFunctions {
	...
	public static class EmptyFunction extends AbstractFloat2DoubleFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public double getOrDefault(final float k, final double defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractFloat2DoubleFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public double getOrDefault(final float k, final double defaultValue) { return ( Float.floatToIntBits(key) == Float.floatToIntBits(k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Float2DoubleFunction , java.io.Serializable {
	 ...
	 @Override
	 public double getOrDefault(final float k, final double defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractFloat2DoubleFunction implements java.io.Serializable {
	 ...
	 @Override
	 public double getOrDefault(final float k, final double defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
