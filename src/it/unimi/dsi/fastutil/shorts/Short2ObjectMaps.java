...
public final class Short2ObjectMaps {
	...
	public static <V> ObjectIterable<Short2ObjectMap.Entry <V> > fastIterable(Short2ObjectMap <V> map) {
	 ...
	 return entries instanceof Short2ObjectMap.FastEntrySet ? new ObjectIterable<Short2ObjectMap.Entry <V> >() {
	  ...
	  @Override
	  public ObjectSpliterator<Short2ObjectMap.Entry <V> > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class SynchronizedMap <V> extends Short2ObjectFunctions.SynchronizedFunction <V> implements Short2ObjectMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public V computeIfAbsent(final short key, final Short2ObjectFunction <? extends V> mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap <V> extends Short2ObjectFunctions.UnmodifiableFunction <V> implements Short2ObjectMap <V>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Short2ObjectMap.Entry <V> > short2ObjectEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.short2ObjectEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public V getOrDefault(final short key, final V defaultValue) { return ((Short2ObjectMap <V>)map).getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 @Override
	 public V computeIfAbsent(final short key, final Short2ObjectFunction <? extends V> mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public V getOrDefault(final Object key, final V defaultValue) { return ((Short2ObjectMap <V>)map).getOrDefault(key, defaultValue); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <V> Short2ObjectMap <V> unmodifiable(final Short2ObjectMap <? extends V> m) { return new UnmodifiableMap <>(m); }
}
