...
public abstract class AbstractLongBigList extends AbstractLongCollection implements LongBigList , LongStack {
	...
	public LongBigListIterator listIterator(final long index) {
	 ...
	 return new LongBigListIterators.AbstractIndexBasedBigListIterator (0, index) {
	  @Override
	  protected final long get(long i) { return AbstractLongBigList.this.getLong(i); }
	  @Override
	  protected final void add(long i, long k) { AbstractLongBigList.this.add(i, k); }
	  @Override
	  protected final void set(long i, long k) { AbstractLongBigList.this.set(i, k); }
	  @Override
	  protected final void remove(long i) { AbstractLongBigList.this.removeLong(i); }
	  @Override
	  protected final long getMaxPos() { return AbstractLongBigList.this.size64(); }
	 };
	}
	static final class IndexBasedSpliterator extends LongBigSpliterators.LateBindingSizeIndexBasedSpliterator {
	 ...
	 @Override
	 protected final long get(long i) { return l.getLong(i); }
	 @Override
	...
	public static class LongSubList extends AbstractLongBigList implements java.io.Serializable {
	 ...
	 private final class RandomAccessIter extends LongBigListIterators.AbstractIndexBasedBigListIterator {
	  ...
	  @Override
	  protected final long get(long i) { return l.getLong(from + i); }
	  // Remember, these are calling SUBLIST's methods, meaning 0 is the start of the sublist for these.
	  @Override
	  protected final void add(long i, long k) { LongSubList.this.add(i, k); }
	  @Override
	  protected final void set(long i, long k) { LongSubList.this.set(i, k); }
	  @Override
	  protected final void remove(long i) { LongSubList.this.removeLong(i); }
	  @Override
	 ...
	 private class ParentWrappingIter implements LongBigListIterator {
	  ...
	  @Override
	  public long nextLong() { if (! hasNext()) throw new NoSuchElementException(); return parent.nextLong(); }
	  @Override
	  public long previousLong() { if (! hasPrevious()) throw new NoSuchElementException(); return parent.previousLong(); }
	  @Override
	  public void add(long k) { parent.add(k); }
	  @Override
	  public void set(long k) { parent.set(k); }
	  @Override
