...
public final class Long2IntFunctions {
	...
	public static class EmptyFunction extends AbstractLong2IntFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int getOrDefault(final long k, final int defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractLong2IntFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int getOrDefault(final long k, final int defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Long2IntFunction , java.io.Serializable {
	 ...
	 @Override
	 public int getOrDefault(final long k, final int defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractLong2IntFunction implements java.io.Serializable {
	 ...
	 @Override
	 public int getOrDefault(final long k, final int defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
