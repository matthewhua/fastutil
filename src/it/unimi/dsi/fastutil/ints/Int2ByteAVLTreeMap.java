	...
	public ObjectSortedSet<Int2ByteMap.Entry > int2ByteEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Int2ByteMap.Entry >() {
	   final Comparator<? super Int2ByteMap.Entry > comparator = (Int2ByteAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Int2ByteMap.Entry >) (x, y) -> ( Integer.compare((x.getIntKey()),(y.getIntKey())) ) :
	    (Comparator<Int2ByteMap.Entry >) (x, y) -> Int2ByteAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey())
	   );
	   @Override
