...
public final class Int2ReferenceSortedMaps {
	...
	public static class UnmodifiableSortedMap <V> extends Int2ReferenceMaps.UnmodifiableMap <V> implements Int2ReferenceSortedMap <V>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "rawtypes", "unchecked" })
	 @Override
	 public ObjectSortedSet<Int2ReferenceMap.Entry <V> > int2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.int2ReferenceEntrySet()); return (ObjectSortedSet<Int2ReferenceMap.Entry <V> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <V> Int2ReferenceSortedMap <V> unmodifiable(final Int2ReferenceSortedMap <? extends V> m) { return new UnmodifiableSortedMap <>(m); }
}
