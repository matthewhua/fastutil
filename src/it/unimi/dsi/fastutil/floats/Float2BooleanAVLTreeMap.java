	...
	public ObjectSortedSet<Float2BooleanMap.Entry > float2BooleanEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Float2BooleanMap.Entry >() {
	   final Comparator<? super Float2BooleanMap.Entry > comparator = (Float2BooleanAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Float2BooleanMap.Entry >) (x, y) -> ( Float.compare((x.getFloatKey()),(y.getFloatKey())) ) :
	    (Comparator<Float2BooleanMap.Entry >) (x, y) -> Float2BooleanAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey())
	   );
	   @Override
