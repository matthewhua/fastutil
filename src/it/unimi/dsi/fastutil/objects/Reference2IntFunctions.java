...
public final class Reference2IntFunctions {
	...
	public static class Singleton <K> extends AbstractReference2IntFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int getOrDefault(final Object k, final int defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class UnmodifiableFunction <K> extends AbstractReference2IntFunction <K> implements java.io.Serializable {
	 ...
	 public int getOrDefault(final Object k, final int defaultValue) { return ((Reference2IntFunction <K>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public Integer getOrDefault(final Object k, final Integer defaultValue) { return ((Reference2IntFunction <K>)function).getOrDefault(k, defaultValue); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <K> Reference2IntFunction <K> unmodifiable(final Reference2IntFunction <? extends K> f) { return new UnmodifiableFunction <>(f); }
