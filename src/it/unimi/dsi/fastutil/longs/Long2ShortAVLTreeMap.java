	...
	public ObjectSortedSet<Long2ShortMap.Entry > long2ShortEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2ShortMap.Entry >() {
	   final Comparator<? super Long2ShortMap.Entry > comparator = (Long2ShortAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Long2ShortMap.Entry >) (x, y) -> ( Long.compare((x.getLongKey()),(y.getLongKey())) ) :
	    (Comparator<Long2ShortMap.Entry >) (x, y) -> Long2ShortAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey())
	   );
	   @Override
