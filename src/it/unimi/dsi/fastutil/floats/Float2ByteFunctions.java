...
public final class Float2ByteFunctions {
	...
	public static class EmptyFunction extends AbstractFloat2ByteFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public byte getOrDefault(final float k, final byte defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractFloat2ByteFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public byte getOrDefault(final float k, final byte defaultValue) { return ( Float.floatToIntBits(key) == Float.floatToIntBits(k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Float2ByteFunction , java.io.Serializable {
	 ...
	 @Override
	 public byte getOrDefault(final float k, final byte defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractFloat2ByteFunction implements java.io.Serializable {
	 ...
	 @Override
	 public byte getOrDefault(final float k, final byte defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
