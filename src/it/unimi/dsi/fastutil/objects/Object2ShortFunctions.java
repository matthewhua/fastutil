...
public final class Object2ShortFunctions {
	...
	public static class EmptyFunction <K> extends AbstractObject2ShortFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short getOrDefault(final Object k, final short defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton <K> extends AbstractObject2ShortFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short getOrDefault(final Object k, final short defaultValue) { return java.util.Objects.equals(key, k) ? value : defaultValue; }
	 @Override
	...
	public static class UnmodifiableFunction <K> extends AbstractObject2ShortFunction <K> implements java.io.Serializable {
	 ...
	 public short getOrDefault(final Object k, final short defaultValue) { return ((Object2ShortFunction <K>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 */
	public static <K> Object2ShortFunction <K> unmodifiable(final Object2ShortFunction <? extends K> f) { return new UnmodifiableFunction <>(f); }
