	 ...
	 return new AbstractFloatSet () {
	   ...
	   public FloatSpliterator spliterator() {
	    return FloatSpliterators.asSpliterator(
	     iterator(), sizeOf(AbstractFloat2LongMap.this), FloatSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
	   }
	  };
	}
	 ...
	 return new AbstractLongCollection () {
	   ...
	   public LongSpliterator spliterator() {
	    return LongSpliterators.asSpliterator(
	     iterator(), sizeOf(AbstractFloat2LongMap.this), LongSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
	   }
	  };
	}
	/** {@inheritDoc} */
