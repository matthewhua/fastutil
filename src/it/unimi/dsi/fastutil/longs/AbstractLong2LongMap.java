...
public abstract class AbstractLong2LongMap extends AbstractLong2LongFunction implements Long2LongMap , java.io.Serializable {
	 ...
	 return new AbstractLongSet () {
	   ...
	   public LongSpliterator spliterator() {
	    return LongSpliterators.asSpliterator(
	     iterator(), sizeOf(AbstractLong2LongMap.this), LongSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
	   }
	  };
	}
	...
	public LongCollection values() {
	 return new AbstractLongCollection () {
	   ...
	   public LongSpliterator spliterator() {
	    return LongSpliterators.asSpliterator(
	     iterator(), sizeOf(AbstractLong2LongMap.this), LongSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
	   }
	  };
	}
	/** {@inheritDoc} */
