...
public final class Reference2LongFunctions {
	...
	public static class Singleton <K> extends AbstractReference2LongFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long getOrDefault(final Object k, final long defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class UnmodifiableFunction <K> extends AbstractReference2LongFunction <K> implements java.io.Serializable {
	 ...
	 public long getOrDefault(final Object k, final long defaultValue) { return ((Reference2LongFunction <K>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 */
	public static <K> Reference2LongFunction <K> unmodifiable(final Reference2LongFunction <? extends K> f) { return new UnmodifiableFunction <>(f); }
