	...
	public ObjectSortedSet<Float2ObjectMap.Entry <V> > float2ObjectEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Float2ObjectMap.Entry <V> >() {
	   final Comparator<? super Float2ObjectMap.Entry <V> > comparator = (Float2ObjectAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Float2ObjectMap.Entry <V> >) (x, y) -> ( Float.compare((x.getFloatKey()),(y.getFloatKey())) ) :
	    (Comparator<Float2ObjectMap.Entry <V> >) (x, y) -> Float2ObjectAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey())
	   );
	   @Override
