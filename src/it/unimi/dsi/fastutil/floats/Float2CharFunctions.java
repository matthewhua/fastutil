...
public final class Float2CharFunctions {
	...
	public static class EmptyFunction extends AbstractFloat2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char getOrDefault(final float k, final char defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractFloat2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char getOrDefault(final float k, final char defaultValue) { return ( Float.floatToIntBits(key) == Float.floatToIntBits(k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Float2CharFunction , java.io.Serializable {
	 ...
	 @Override
	 public char getOrDefault(final float k, final char defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractFloat2CharFunction implements java.io.Serializable {
	 ...
	 @Override
	 public char getOrDefault(final float k, final char defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
