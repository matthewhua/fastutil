	 ...
	 return new AbstractShortSet () {
	   ...
	   public ShortSpliterator spliterator() {
	    return ShortSpliterators.asSpliterator(
	     iterator(), sizeOf(AbstractShort2FloatMap.this), ShortSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
	   }
	  };
	}
	 ...
	 return new AbstractFloatCollection () {
	   ...
	   public FloatSpliterator spliterator() {
	    return FloatSpliterators.asSpliterator(
	     iterator(), sizeOf(AbstractShort2FloatMap.this), FloatSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
	   }
	  };
	}
	/** {@inheritDoc} */
