...
public interface ObjectBigList <K> extends BigList<K>, ObjectCollection <K>, Comparable<BigList<? extends K>> {
	 ...
	 */
	default boolean addAll(final long index, final ObjectBigList <? extends K> l) { return addAll(index, (ObjectCollection <? extends K>) l); }
	 ...
	 */
	default boolean addAll(final ObjectBigList <? extends K> l) { return addAll(size64(), l); }
	 ...
	 * @see BigList#addAll(long,Collection)
	 */
	default boolean addAll(final long index, final ObjectList <? extends K> l) { return addAll(index, (ObjectCollection <? extends K>) l); }
	 ...
	 * @see BigList#addAll(Collection)
	 */
	default boolean addAll(final ObjectList <? extends K> l) { return addAll(size64(), l); }
