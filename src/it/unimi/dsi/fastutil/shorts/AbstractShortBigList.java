...
public abstract class AbstractShortBigList extends AbstractShortCollection implements ShortBigList , ShortStack {
	...
	public ShortBigListIterator listIterator(final long index) {
	 ...
	 return new ShortBigListIterators.AbstractIndexBasedBigListIterator (0, index) {
	  @Override
	  protected final short get(long i) { return AbstractShortBigList.this.getShort(i); }
	  @Override
	  protected final void add(long i, short k) { AbstractShortBigList.this.add(i, k); }
	  @Override
	  protected final void set(long i, short k) { AbstractShortBigList.this.set(i, k); }
	  @Override
	  protected final void remove(long i) { AbstractShortBigList.this.removeShort(i); }
	  @Override
	  protected final long getMaxPos() { return AbstractShortBigList.this.size64(); }
	 };
	}
	static final class IndexBasedSpliterator extends ShortBigSpliterators.LateBindingSizeIndexBasedSpliterator {
	 ...
	 @Override
	 protected final short get(long i) { return l.getShort(i); }
	 @Override
	...
	public static class ShortSubList extends AbstractShortBigList implements java.io.Serializable {
	 ...
	 private final class RandomAccessIter extends ShortBigListIterators.AbstractIndexBasedBigListIterator {
	  ...
	  @Override
	  protected final short get(long i) { return l.getShort(from + i); }
	  // Remember, these are calling SUBLIST's methods, meaning 0 is the start of the sublist for these.
	  @Override
	  protected final void add(long i, short k) { ShortSubList.this.add(i, k); }
	  @Override
	  protected final void set(long i, short k) { ShortSubList.this.set(i, k); }
	  @Override
	  protected final void remove(long i) { ShortSubList.this.removeShort(i); }
	  @Override
