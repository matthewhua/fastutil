...
public final class Short2ObjectFunctions {
	...
	public static class UnmodifiableFunction <V> extends AbstractShort2ObjectFunction <V> implements java.io.Serializable {
	 ...
	 public V getOrDefault(final short k, final V defaultValue) { return ((Short2ObjectFunction <V>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public V getOrDefault(final Object k, final V defaultValue) { return ((Short2ObjectFunction <V>)function).getOrDefault(k, defaultValue); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <V> Short2ObjectFunction <V> unmodifiable(final Short2ObjectFunction <? extends V> f) { return new UnmodifiableFunction <>(f); }
