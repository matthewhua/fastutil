...
public interface IntCollection extends Collection<Integer>, IntIterable {
	 ...
	 */
	@Override
	default IntIterator intIterator() { return iterator(); }
	...
	default IntSpliterator spliterator() {
	 return IntSpliterators.asSpliterator(
	   iterator(), sizeOf(this), IntSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
	}
	 ...
	 */
	@Override
	default IntSpliterator intSpliterator() { return spliterator(); }
	...
	@Deprecated
	@Override
	default java.util.stream.Stream<Integer> stream() { return Collection.super.stream(); }
	...
	@Deprecated
	@Override
	default java.util.stream.Stream<Integer> parallelStream() { return Collection.super.parallelStream(); }
