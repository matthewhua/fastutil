...
public final class Reference2ReferenceFunctions {
	...
	public static class Singleton <K,V> extends AbstractReference2ReferenceFunction <K,V> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public V getOrDefault(final Object k, final V defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class UnmodifiableFunction <K,V> extends AbstractReference2ReferenceFunction <K,V> implements java.io.Serializable {
	 ...
	 public V getOrDefault(final Object k, final V defaultValue) { return ((Reference2ReferenceFunction <K,V>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 */
	public static <K,V> Reference2ReferenceFunction <K,V> unmodifiable(final Reference2ReferenceFunction <? extends K, ? extends V> f) { return new UnmodifiableFunction <>(f); }
}
