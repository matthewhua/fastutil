...
public class FloatFloatImmutableSortedPair extends FloatFloatImmutablePair implements FloatFloatSortedPair, java.io.Serializable {
	...
	public boolean equals(Object other) {
	 ...
	 if (other instanceof FloatFloatSortedPair) {
	  return
	left == ((FloatFloatSortedPair)other).leftFloat()
	&& right == ((FloatFloatSortedPair)other).rightFloat();
	 }
	 if (other instanceof it.unimi.dsi.fastutil.SortedPair) {
	  return
	java.util.Objects.equals(Float.valueOf(left), ((it.unimi.dsi.fastutil.SortedPair)other).left())
	&& java.util.Objects.equals(Float.valueOf(right), ((it.unimi.dsi.fastutil.SortedPair)other).right());
	 }
	 return false;
	}
