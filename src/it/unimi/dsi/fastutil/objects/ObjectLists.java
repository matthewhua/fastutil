...
public final class ObjectLists {
	...
	public static class EmptyList <K> extends ObjectCollections.EmptyCollection <K> implements ObjectList <K>, RandomAccess, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public void replaceAll(final java.util.function.UnaryOperator<K> operator) { throw new UnsupportedOperationException(); }
	 ...
	 @Override
	 public void setElements(final K a[]) { throw new UnsupportedOperationException(); }
	 @Override
	 public void setElements(int index, final K a[]) { throw new UnsupportedOperationException(); }
	 @Override
	 public void setElements(int index, final K a[], int offset, int length) { throw new UnsupportedOperationException(); }
	 @Override
	...
	public static class Singleton <K> extends AbstractObjectList <K> implements RandomAccess, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int indexOf(final Object k) { return java.util.Objects.equals(k, element) ? 0 : -1; }
	 /* Slightly optimized w.r.t. the one in ABSTRACT_SET. */
	 @Override
	 public Object[] toArray() { return new Object[]{element}; }
	 @Override
	 ...
	 @Override
	 public ObjectSpliterator <K> spliterator() { return ObjectSpliterators.singleton(element); }
	 @Override
	 ...
	 @Override
	 public void forEach(final Consumer<? super K> action) { action.accept((element)); }
	 @Override
	 public boolean addAll(int i, Collection<? extends K> c) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 @Override
	 public boolean removeIf(final java.util.function.Predicate<? super K> filter) { throw new UnsupportedOperationException(); }
	 @Override
	 public void replaceAll(final java.util.function.UnaryOperator<K> operator) { throw new UnsupportedOperationException(); }
	 ...
	 public void removeElements(int from, int to) { throw new UnsupportedOperationException(); }
	 @Override
	 public void addElements(int index, K a[]) { throw new UnsupportedOperationException(); }
	 @Override
	 public void addElements(int index, K a[], int offset, int length) { throw new UnsupportedOperationException(); }
	 @Override
	 public void setElements(final K a[]) { throw new UnsupportedOperationException(); }
	 @Override
	 public void setElements(int index, final K a[]) { throw new UnsupportedOperationException(); }
	...
	public static class SynchronizedList <K> extends ObjectCollections.SynchronizedCollection <K> implements ObjectList <K>, java.io.Serializable {
	 ...
	 @Override
	 public boolean removeIf(final Predicate <? super K> filter) { synchronized(sync) { return list.removeIf(filter); } }
	 @Override
	 public void replaceAll(final UnaryOperator <K> operator) { synchronized(sync) { list.replaceAll(operator); } }
	 @Override
	 ...
	 @Override
	 public void setElements(final K a[]) { synchronized(sync) { list.setElements(a); } }
	 @Override
	 public void setElements(int index, final K a[]) { synchronized(sync) { list.setElements(index, a); } }
	 @Override
	 public void setElements(int index, final K a[], int offset, int length) { synchronized(sync) { list.setElements(index, a, offset, length); } }
	 @Override
	 ...
	 @Override
	 public void sort(final java.util.Comparator<? super K> comparator) { synchronized(sync) {list.sort(comparator); } }
	
	 @Override
	 public void unstableSort(final java.util.Comparator<? super K> comparator) { synchronized(sync) {list.unstableSort(comparator); } }
	...
	public static class UnmodifiableList <K> extends ObjectCollections.UnmodifiableCollection <K> implements ObjectList <K>, java.io.Serializable {
	 private static final long serialVersionUID = -7046029254386353129L;
	 protected final ObjectList <? extends K> list; // Due to the large number of methods that are not in COLLECTION, this is worth caching.
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public int compareTo(final List<? extends K> o) { return ((ObjectList <K>)list).compareTo(o); }
	
	 @Override
	 public void sort(final java.util.Comparator<? super K> comparator) { throw new UnsupportedOperationException(); }
	
	 @Override
	 public void unstableSort(final java.util.Comparator<? super K> comparator) { throw new UnsupportedOperationException(); }
	}
