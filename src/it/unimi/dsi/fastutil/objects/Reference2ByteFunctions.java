...
public final class Reference2ByteFunctions {
	...
	public static class Singleton <K> extends AbstractReference2ByteFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public byte getOrDefault(final Object k, final byte defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class UnmodifiableFunction <K> extends AbstractReference2ByteFunction <K> implements java.io.Serializable {
	 ...
	 public byte getOrDefault(final Object k, final byte defaultValue) { return ((Reference2ByteFunction <K>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 */
	public static <K> Reference2ByteFunction <K> unmodifiable(final Reference2ByteFunction <? extends K> f) { return new UnmodifiableFunction <>(f); }
