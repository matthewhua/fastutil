	...
	public ObjectSortedSet<Float2FloatMap.Entry > float2FloatEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Float2FloatMap.Entry >() {
	   final Comparator<? super Float2FloatMap.Entry > comparator = (Float2FloatAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Float2FloatMap.Entry >) (x, y) -> ( Float.compare((x.getFloatKey()),(y.getFloatKey())) ) :
	    (Comparator<Float2FloatMap.Entry >) (x, y) -> Float2FloatAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey())
	   );
	   @Override
