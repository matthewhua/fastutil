	...
	public ObjectSortedSet<Long2ObjectMap.Entry <V> > long2ObjectEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry <V> >() {
	   final Comparator<? super Long2ObjectMap.Entry <V> > comparator = (Long2ObjectAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Long2ObjectMap.Entry <V> >) (x, y) -> ( Long.compare((x.getLongKey()),(y.getLongKey())) ) :
	    (Comparator<Long2ObjectMap.Entry <V> >) (x, y) -> Long2ObjectAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey())
	   );
	   @Override
