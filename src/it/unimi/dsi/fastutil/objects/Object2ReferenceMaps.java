...
public final class Object2ReferenceMaps {
	...
	public static <K,V> ObjectIterable<Object2ReferenceMap.Entry <K,V> > fastIterable(Object2ReferenceMap <K,V> map) {
	 ...
	 return entries instanceof Object2ReferenceMap.FastEntrySet ? new ObjectIterable<Object2ReferenceMap.Entry <K,V> >() {
	  ...
	  @Override
	  public ObjectSpliterator<Object2ReferenceMap.Entry <K,V> > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class UnmodifiableMap <K,V> extends Object2ReferenceFunctions.UnmodifiableFunction <K,V> implements Object2ReferenceMap <K,V>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Object2ReferenceMap.Entry <K,V> > object2ReferenceEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2ReferenceEntrySet()); return entries; }
	 /** {@inheritDoc} */
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Map.Entry<K, V>> entrySet() { return (ObjectSet)object2ReferenceEntrySet(); }
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public V getOrDefault(final Object key, final V defaultValue) { return ((Object2ReferenceMap <K,V>)map).getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 */
	public static <K,V> Object2ReferenceMap <K,V> unmodifiable(final Object2ReferenceMap <? extends K, ? extends V> m) { return new UnmodifiableMap <>(m); }
}
