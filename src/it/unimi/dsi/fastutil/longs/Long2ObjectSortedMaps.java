...
public final class Long2ObjectSortedMaps {
	...
	public static class UnmodifiableSortedMap <V> extends Long2ObjectMaps.UnmodifiableMap <V> implements Long2ObjectSortedMap <V>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "rawtypes", "unchecked" })
	 @Override
	 public ObjectSortedSet<Long2ObjectMap.Entry <V> > long2ObjectEntrySet() { if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.long2ObjectEntrySet()); return (ObjectSortedSet<Long2ObjectMap.Entry <V> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <V> Long2ObjectSortedMap <V> unmodifiable(final Long2ObjectSortedMap <? extends V> m) { return new UnmodifiableSortedMap <>(m); }
}
