...
public interface FloatBigList extends BigList<Float>, FloatCollection , Comparable<BigList<? extends Float>> {
	...
	default FloatSpliterator spliterator() {
	 return FloatSpliterators.asSpliterator(
	   iterator(), size64(), FloatSpliterators.LIST_SPLITERATOR_CHARACTERISTICS);
	}
	 ...
	 */
	default boolean addAll(final long index, final FloatBigList l) { return addAll(index, (FloatCollection ) l); }
	 ...
	 */
	default boolean addAll(final FloatBigList l) { return addAll(size64(), l); }
	 ...
	 * @see BigList#addAll(long,Collection)
	 */
	default boolean addAll(final long index, final FloatList l) { return addAll(index, (FloatCollection ) l); }
	 ...
	 * @see BigList#addAll(Collection)
	 */
	default boolean addAll(final FloatList l) { return addAll(size64(), l); }
