	...
	public ObjectSortedSet<Long2LongMap.Entry > long2LongEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2LongMap.Entry >() {
	   final Comparator<? super Long2LongMap.Entry > comparator = (Long2LongAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Long2LongMap.Entry >) (x, y) -> ( Long.compare((x.getLongKey()),(y.getLongKey())) ) :
	    (Comparator<Long2LongMap.Entry >) (x, y) -> Long2LongAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey())
	   );
	   @Override
