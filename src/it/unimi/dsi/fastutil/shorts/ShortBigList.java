...
public interface ShortBigList extends BigList<Short>, ShortCollection , Comparable<BigList<? extends Short>> {
	...
	default ShortSpliterator spliterator() {
	 return ShortSpliterators.asSpliterator(
	   iterator(), size64(), ShortSpliterators.LIST_SPLITERATOR_CHARACTERISTICS);
	}
	 ...
	 */
	default boolean addAll(final long index, final ShortBigList l) { return addAll(index, (ShortCollection ) l); }
	 ...
	 */
	default boolean addAll(final ShortBigList l) { return addAll(size64(), l); }
	 ...
	 * @see BigList#addAll(long,Collection)
	 */
	default boolean addAll(final long index, final ShortList l) { return addAll(index, (ShortCollection ) l); }
	 ...
	 * @see BigList#addAll(Collection)
	 */
	default boolean addAll(final ShortList l) { return addAll(size64(), l); }
