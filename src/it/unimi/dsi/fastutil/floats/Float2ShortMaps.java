...
public final class Float2ShortMaps {
	...
	public static ObjectIterable<Float2ShortMap.Entry > fastIterable(Float2ShortMap map) {
	 ...
	 return entries instanceof Float2ShortMap.FastEntrySet ? new ObjectIterable<Float2ShortMap.Entry >() {
	  ...
	  @Override
	  public ObjectSpliterator<Float2ShortMap.Entry > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class EmptyMap extends Float2ShortFunctions.EmptyFunction implements Float2ShortMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short getOrDefault(final float key, final short defaultValue) { return defaultValue; }
	 /** {@inheritDoc}
	...
	public static class SynchronizedMap extends Float2ShortFunctions.SynchronizedFunction implements Float2ShortMap , java.io.Serializable {
	 ...
	 @Override
	 public short computeIfAbsent(final float key, final Float2ShortFunction mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap extends Float2ShortFunctions.UnmodifiableFunction implements Float2ShortMap , java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Float2ShortMap.Entry > float2ShortEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.float2ShortEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 @Override
	 public short computeIfAbsent(final float key, final Float2ShortFunction mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
