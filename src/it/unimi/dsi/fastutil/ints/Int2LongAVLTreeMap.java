	...
	public ObjectSortedSet<Int2LongMap.Entry > int2LongEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Int2LongMap.Entry >() {
	   final Comparator<? super Int2LongMap.Entry > comparator = (Int2LongAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Int2LongMap.Entry >) (x, y) -> ( Integer.compare((x.getIntKey()),(y.getIntKey())) ) :
	    (Comparator<Int2LongMap.Entry >) (x, y) -> Int2LongAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey())
	   );
	   @Override
