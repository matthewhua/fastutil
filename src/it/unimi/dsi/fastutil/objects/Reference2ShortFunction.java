...
default it.unimi.dsi.fastutil.objects.Reference2ByteFunction <K> andThenByte(it.unimi.dsi.fastutil.shorts.Short2ByteFunction after) { return k -> after.get(getShort(k)); } default it.unimi.dsi.fastutil.bytes.Byte2ShortFunction composeByte(it.unimi.dsi.fastutil.bytes.Byte2ReferenceFunction <K> before) { return k -> getShort(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Reference2ShortFunction <K> andThenShort(it.unimi.dsi.fastutil.shorts.Short2ShortFunction after) { return k -> after.get(getShort(k)); } default it.unimi.dsi.fastutil.shorts.Short2ShortFunction composeShort(it.unimi.dsi.fastutil.shorts.Short2ReferenceFunction <K> before) { return k -> getShort(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Reference2IntFunction <K> andThenInt(it.unimi.dsi.fastutil.shorts.Short2IntFunction after) { return k -> after.get(getShort(k)); } default it.unimi.dsi.fastutil.ints.Int2ShortFunction composeInt(it.unimi.dsi.fastutil.ints.Int2ReferenceFunction <K> before) { return k -> getShort(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Reference2LongFunction <K> andThenLong(it.unimi.dsi.fastutil.shorts.Short2LongFunction after) { return k -> after.get(getShort(k)); } default it.unimi.dsi.fastutil.longs.Long2ShortFunction composeLong(it.unimi.dsi.fastutil.longs.Long2ReferenceFunction <K> before) { return k -> getShort(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Reference2CharFunction <K> andThenChar(it.unimi.dsi.fastutil.shorts.Short2CharFunction after) { return k -> after.get(getShort(k)); } default it.unimi.dsi.fastutil.chars.Char2ShortFunction composeChar(it.unimi.dsi.fastutil.chars.Char2ReferenceFunction <K> before) { return k -> getShort(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Reference2FloatFunction <K> andThenFloat(it.unimi.dsi.fastutil.shorts.Short2FloatFunction after) { return k -> after.get(getShort(k)); } default it.unimi.dsi.fastutil.floats.Float2ShortFunction composeFloat(it.unimi.dsi.fastutil.floats.Float2ReferenceFunction <K> before) { return k -> getShort(before.get(k)); }
default it.unimi.dsi.fastutil.objects.Reference2DoubleFunction <K> andThenDouble(it.unimi.dsi.fastutil.shorts.Short2DoubleFunction after) { return k -> after.get(getShort(k)); } default it.unimi.dsi.fastutil.doubles.Double2ShortFunction composeDouble(it.unimi.dsi.fastutil.doubles.Double2ReferenceFunction <K> before) { return k -> getShort(before.get(k)); }
default <T> it.unimi.dsi.fastutil.objects.Reference2ObjectFunction <K, T> andThenObject(it.unimi.dsi.fastutil.shorts.Short2ObjectFunction <? extends T> after) { return k -> after.get(getShort(k)); } default <T> it.unimi.dsi.fastutil.objects.Object2ShortFunction <T> composeObject(it.unimi.dsi.fastutil.objects.Object2ReferenceFunction <? super T, ? extends K> before) { return k -> getShort(before.get(k)); }
default <T> it.unimi.dsi.fastutil.objects.Reference2ReferenceFunction <K, T> andThenReference(it.unimi.dsi.fastutil.shorts.Short2ReferenceFunction <? extends T> after) { return k -> after.get(getShort(k)); } default <T> it.unimi.dsi.fastutil.objects.Reference2ShortFunction <T> composeReference(it.unimi.dsi.fastutil.objects.Reference2ReferenceFunction <? super T, ? extends K> before) { return k -> getShort(before.get(k)); }
}
