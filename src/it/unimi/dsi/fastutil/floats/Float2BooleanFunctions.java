...
public final class Float2BooleanFunctions {
	...
	public static class EmptyFunction extends AbstractFloat2BooleanFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean getOrDefault(final float k, final boolean defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractFloat2BooleanFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean getOrDefault(final float k, final boolean defaultValue) { return ( Float.floatToIntBits(key) == Float.floatToIntBits(k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Float2BooleanFunction , java.io.Serializable {
	 ...
	 @Override
	 public boolean getOrDefault(final float k, final boolean defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractFloat2BooleanFunction implements java.io.Serializable {
	 ...
	 @Override
	 public boolean getOrDefault(final float k, final boolean defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
