...
public interface LongBigList extends BigList<Long>, LongCollection , Comparable<BigList<? extends Long>> {
	...
	default LongSpliterator spliterator() {
	 return LongSpliterators.asSpliterator(
	   iterator(), size64(), LongSpliterators.LIST_SPLITERATOR_CHARACTERISTICS);
	}
	 ...
	 */
	default boolean addAll(final long index, final LongBigList l) { return addAll(index, (LongCollection ) l); }
	 ...
	 */
	default boolean addAll(final LongBigList l) { return addAll(size64(), l); }
	 ...
	 * @see BigList#addAll(long,Collection)
	 */
	default boolean addAll(final long index, final LongList l) { return addAll(index, (LongCollection ) l); }
	 ...
	 * @see BigList#addAll(Collection)
	 */
	default boolean addAll(final LongList l) { return addAll(size64(), l); }
