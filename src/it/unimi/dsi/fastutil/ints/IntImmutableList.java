...
public class IntImmutableList extends IntLists.ImmutableListBase implements IntList , RandomAccess, Cloneable, java.io.Serializable {
	...
	public IntListIterator listIterator(final int index) {
	 ...
	 return new IntListIterator () {
	   ...
	   @Override
	   public int nextInt() { if (! hasNext()) throw new NoSuchElementException(); return a[pos++]; }
	   @Override
	   public int previousInt() { if (! hasPrevious()) throw new NoSuchElementException(); return a[--pos]; }
	   @Override
	 ...
	 @Override
	 public int characteristics() { return IntSpliterators.LIST_SPLITERATOR_CHARACTERISTICS | java.util.Spliterator.IMMUTABLE; }
	 @Override
	...
	private final static class ImmutableSubList extends IntLists.ImmutableListBase implements java.util.RandomAccess, java.io.Serializable {
	 ...
	 public IntListIterator listIterator(final int index) {
	  ...
	  return new IntListIterator () {
	    ...
	    @Override
	    public int nextInt() { if (! hasNext()) throw new NoSuchElementException(); return a[pos++ + from]; }
	    @Override
	    public int previousInt() { if (! hasPrevious()) throw new NoSuchElementException(); return a[--pos + from]; }
	    @Override
	    public int nextIndex() { return pos; }
	    @Override
	    public int previousIndex() { return pos - 1; }
