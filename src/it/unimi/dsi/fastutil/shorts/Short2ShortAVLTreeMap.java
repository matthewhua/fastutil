	...
	public ObjectSortedSet<Short2ShortMap.Entry > short2ShortEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Short2ShortMap.Entry >() {
	   final Comparator<? super Short2ShortMap.Entry > comparator = (Short2ShortAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Short2ShortMap.Entry >) (x, y) -> ( Short.compare((x.getShortKey()),(y.getShortKey())) ) :
	    (Comparator<Short2ShortMap.Entry >) (x, y) -> Short2ShortAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey())
	   );
	   @Override
