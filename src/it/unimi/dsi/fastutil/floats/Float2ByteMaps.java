...
public final class Float2ByteMaps {
	...
	public static ObjectIterable<Float2ByteMap.Entry > fastIterable(Float2ByteMap map) {
	 ...
	 return entries instanceof Float2ByteMap.FastEntrySet ? new ObjectIterable<Float2ByteMap.Entry >() {
	  ...
	  @Override
	  public ObjectSpliterator<Float2ByteMap.Entry > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class EmptyMap extends Float2ByteFunctions.EmptyFunction implements Float2ByteMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public byte getOrDefault(final float key, final byte defaultValue) { return defaultValue; }
	 /** {@inheritDoc}
	...
	public static class SynchronizedMap extends Float2ByteFunctions.SynchronizedFunction implements Float2ByteMap , java.io.Serializable {
	 ...
	 @Override
	 public byte computeIfAbsent(final float key, final Float2ByteFunction mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap extends Float2ByteFunctions.UnmodifiableFunction implements Float2ByteMap , java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Float2ByteMap.Entry > float2ByteEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.float2ByteEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 @Override
	 public byte computeIfAbsent(final float key, final Float2ByteFunction mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
