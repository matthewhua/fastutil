...
public final class ShortLists {
	...
	public static class EmptyList extends ShortCollections.EmptyCollection implements ShortList , RandomAccess, java.io.Serializable, Cloneable {
	 ...
	 @Deprecated
	 @Override
	 public void replaceAll(final java.util.function.UnaryOperator<Short> operator) { throw new UnsupportedOperationException(); }
	 @Override
	 public void replaceAll(final ShortUnaryOperator operator) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 @Override
	 public void setElements(final short a[]) { throw new UnsupportedOperationException(); }
	 @Override
	 public void setElements(int index, final short a[]) { throw new UnsupportedOperationException(); }
	 @Override
	 public void setElements(int index, final short a[], int offset, int length) { throw new UnsupportedOperationException(); }
	 @Override
	...
	public static class Singleton extends AbstractShortList implements RandomAccess, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int indexOf(final short k) { return ( (k) == (element) ) ? 0 : -1; }
	 /* Slightly optimized w.r.t. the one in ABSTRACT_SET. */
	 @Override
	 public short[] toShortArray() { return new short[]{element}; }
	 @Override
	 ...
	 @Deprecated
	 @Override
	 public void forEach(final Consumer<? super Short> action) { action.accept(Short.valueOf(element)); }
	 @Override
	 public boolean addAll(int i, Collection<? extends Short> c) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 @Deprecated
	 @Override
	 public boolean removeIf(final java.util.function.Predicate<? super Short> filter) { throw new UnsupportedOperationException(); }
	 @Deprecated
	 @Override
	 public void replaceAll(final java.util.function.UnaryOperator<Short> operator) { throw new UnsupportedOperationException(); }
	 @Override
	 public void replaceAll(final ShortUnaryOperator operator) { throw new UnsupportedOperationException(); }
	 @Override
	 public void forEach(final ShortConsumer action) { action.accept(element); }
	 @Override
	 public boolean addAll(ShortList c) { throw new UnsupportedOperationException(); }
	 @Override
	 public boolean addAll(int i, ShortList c) { throw new UnsupportedOperationException(); }
	 ...
	 @Override
	 public boolean removeIf(final ShortPredicate filter) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 @Deprecated
	 @Override
	 public Object[] toArray() { return new Object[]{ Short.valueOf(element) }; }
	 ...
	 public void removeElements(int from, int to) { throw new UnsupportedOperationException(); }
	 @Override
	 public void addElements(int index, short a[]) { throw new UnsupportedOperationException(); }
	 @Override
	 public void addElements(int index, short a[], int offset, int length) { throw new UnsupportedOperationException(); }
	 @Override
	 public void setElements(final short a[]) { throw new UnsupportedOperationException(); }
	 @Override
	 public void setElements(int index, final short a[]) { throw new UnsupportedOperationException(); }
	...
	public static class SynchronizedList extends ShortCollections.SynchronizedCollection implements ShortList , java.io.Serializable {
	 ...
	 @Override
	 public boolean removeIf(final ShortPredicate filter) { synchronized(sync) { return list.removeIf(filter); } }
	 @Override
	 public void replaceAll(final ShortUnaryOperator operator) { synchronized(sync) { list.replaceAll(operator); } }
	 @Override
	 ...
	 @Override
	 public void setElements(final short a[]) { synchronized(sync) { list.setElements(a); } }
	 @Override
	 public void setElements(int index, final short a[]) { synchronized(sync) { list.setElements(index, a); } }
	 @Override
	 public void setElements(int index, final short a[], int offset, int length) { synchronized(sync) { list.setElements(index, a, offset, length); } }
	 @Override
	 ...
	 @Override
	 public void sort(final ShortComparator comparator) { synchronized(sync) { list.sort(comparator); } }
	 @Override
	 public void unstableSort(final ShortComparator comparator) { synchronized(sync) { list.unstableSort(comparator); } }
	 @Deprecated
	 @Override
	 public void sort(final java.util.Comparator<? super Short> comparator) { synchronized(sync) {list.sort(comparator); } }
	 @Deprecated
	 @Override
	 public void unstableSort(final java.util.Comparator<? super Short> comparator) { synchronized(sync) {list.unstableSort(comparator); } }
	...
	public static class UnmodifiableList extends ShortCollections.UnmodifiableCollection implements ShortList , java.io.Serializable {
	 ...
	 @Override
	 public void sort(final ShortComparator comparator) { throw new UnsupportedOperationException(); }
	 @Override
	 public void unstableSort(final ShortComparator comparator) { throw new UnsupportedOperationException(); }
	 @Deprecated
	 @Override
	 public void sort(final java.util.Comparator<? super Short> comparator) { throw new UnsupportedOperationException(); }
	 @Deprecated
	 @Override
	 public void unstableSort(final java.util.Comparator<? super Short> comparator) { throw new UnsupportedOperationException(); }
	}
