...
public final class Object2LongFunctions {
	...
	public static class EmptyFunction <K> extends AbstractObject2LongFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long getOrDefault(final Object k, final long defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton <K> extends AbstractObject2LongFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long getOrDefault(final Object k, final long defaultValue) { return java.util.Objects.equals(key, k) ? value : defaultValue; }
	 @Override
	...
	public static class UnmodifiableFunction <K> extends AbstractObject2LongFunction <K> implements java.io.Serializable {
	 ...
	 public long getOrDefault(final Object k, final long defaultValue) { return ((Object2LongFunction <K>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 */
	public static <K> Object2LongFunction <K> unmodifiable(final Object2LongFunction <? extends K> f) { return new UnmodifiableFunction <>(f); }
