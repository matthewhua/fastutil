	...
	public ReferenceSet <K> keySet() {
	 return new AbstractReferenceSet <K>() {
	   ...
	   public ObjectSpliterator <K> spliterator() {
	    return ObjectSpliterators.asSpliterator(
	     iterator(), sizeOf(AbstractReference2LongMap.this), ObjectSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
	   }
	  };
	}
	 ...
	 return new AbstractLongCollection () {
	   ...
	   public LongSpliterator spliterator() {
	    return LongSpliterators.asSpliterator(
	     iterator(), sizeOf(AbstractReference2LongMap.this), LongSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
	   }
	  };
	}
	/** {@inheritDoc} */
