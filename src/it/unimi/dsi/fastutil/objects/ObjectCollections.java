...
public final class ObjectCollections {
	 ...
	 */
	public static <K> ObjectCollection <K> unmodifiable(final ObjectCollection <? extends K> c) { return new UnmodifiableCollection <>(c); }
	...
	static class SizeDecreasingSupplier<
	  K,
	  C extends ObjectCollection <K> > implements Supplier<C> {
