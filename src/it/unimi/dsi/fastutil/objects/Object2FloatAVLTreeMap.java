	...
	public ObjectSortedSet<Object2FloatMap.Entry <K> > object2FloatEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2FloatMap.Entry <K> >() {
	   final Comparator<? super Object2FloatMap.Entry <K> > comparator = (Object2FloatAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Object2FloatMap.Entry <K> >) (x, y) -> ( ((Comparable<K>)(x.getKey())).compareTo(y.getKey()) ) :
	    (Comparator<Object2FloatMap.Entry <K> >) (x, y) -> Object2FloatAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey())
	   );
	   @Override
