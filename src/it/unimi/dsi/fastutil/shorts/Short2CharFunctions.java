...
public final class Short2CharFunctions {
	...
	public static class EmptyFunction extends AbstractShort2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char getOrDefault(final short k, final char defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractShort2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char getOrDefault(final short k, final char defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Short2CharFunction , java.io.Serializable {
	 ...
	 @Override
	 public char getOrDefault(final short k, final char defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractShort2CharFunction implements java.io.Serializable {
	 ...
	 @Override
	 public char getOrDefault(final short k, final char defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
