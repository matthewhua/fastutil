...
public abstract class AbstractShort2ShortMap extends AbstractShort2ShortFunction implements Short2ShortMap , java.io.Serializable {
	 ...
	 return new AbstractShortSet () {
	   ...
	   public ShortSpliterator spliterator() {
	    return ShortSpliterators.asSpliterator(
	     iterator(), sizeOf(AbstractShort2ShortMap.this), ShortSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
	   }
	  };
	}
	...
	public ShortCollection values() {
	 return new AbstractShortCollection () {
	   ...
	   public ShortSpliterator spliterator() {
	    return ShortSpliterators.asSpliterator(
	     iterator(), sizeOf(AbstractShort2ShortMap.this), ShortSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
	   }
	  };
	}
	/** {@inheritDoc} */
