...
public final class ObjectBigLists {
	...
	public static class EmptyBigList <K> extends ObjectCollections.EmptyCollection <K> implements ObjectBigList <K>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public void getElements(long from, Object[][] a, long offset, long length) { BigArrays.ensureOffsetLength(a, offset, length); if (from != 0) throw new IndexOutOfBoundsException(); }
	 @Override
	...
	public static class Singleton <K> extends AbstractObjectBigList <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long indexOf(final Object k) { return java.util.Objects.equals(k, element) ? 0 : -1; }
	...
	public static class UnmodifiableBigList <K> extends ObjectCollections.UnmodifiableCollection <K> implements ObjectBigList <K>, java.io.Serializable {
	 private static final long serialVersionUID = -7046029254386353129L;
	 protected final ObjectBigList <? extends K> list; // Due to the large number of methods that are not in COLLECTION, this is worth caching.
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public int compareTo(final BigList<? extends K> o) { return ((ObjectBigList <K>)list).compareTo(o); }
	}
	 ...
	 */
	public static <K> ObjectBigList <K> unmodifiable(final ObjectBigList <? extends K> l) { return new UnmodifiableBigList <>(l); }
