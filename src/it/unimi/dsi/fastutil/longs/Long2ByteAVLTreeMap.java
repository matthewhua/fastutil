	...
	public ObjectSortedSet<Long2ByteMap.Entry > long2ByteEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2ByteMap.Entry >() {
	   final Comparator<? super Long2ByteMap.Entry > comparator = (Long2ByteAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Long2ByteMap.Entry >) (x, y) -> ( Long.compare((x.getLongKey()),(y.getLongKey())) ) :
	    (Comparator<Long2ByteMap.Entry >) (x, y) -> Long2ByteAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey())
	   );
	   @Override
