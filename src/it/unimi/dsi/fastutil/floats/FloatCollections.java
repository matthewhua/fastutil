...
public final class FloatCollections {
	...
	public abstract static class EmptyCollection extends AbstractFloatCollection {
	 ...
	 public FloatSpliterator spliterator() { return FloatSpliterators.EMPTY_SPLITERATOR; }
	 @Override
	 ...
	 @Override
	 public boolean containsAll(final FloatCollection c) { return c.isEmpty(); }
	 @Override
	 ...
	 @Override
	 public DoubleSpliterator doubleSpliterator() { return DoubleSpliterators.EMPTY_SPLITERATOR; }
	}
	...
	static class SynchronizedCollection implements FloatCollection , java.io.Serializable {
	 ...
	 @Override
	 public DoubleIterator doubleIterator() { return collection.doubleIterator(); }
	 @Override
	 public DoubleSpliterator doubleSpliterator() { return collection.doubleSpliterator(); }
	 @Override
	 public java.util.stream.DoubleStream doubleStream() { return collection.doubleStream(); }
	 @Override
	 public java.util.stream.DoubleStream doubleParallelStream() { return collection.doubleParallelStream(); }
	 @Override
	 ...
	 @Override
	 public FloatSpliterator spliterator() { return collection.spliterator(); }
	 @Deprecated
	 @Override
	 public java.util.stream.Stream <Float> stream() { return collection.stream(); }
	 @Deprecated
	 @Override
	 public java.util.stream.Stream <Float> parallelStream() { return collection.parallelStream(); }
	 @Override
	 public void forEach(final FloatConsumer action) { synchronized(sync) { collection.forEach(action); } }
	 @Override
	 ...
	 @Override
	 public boolean removeIf(final FloatPredicate filter) { synchronized(sync) { return collection.removeIf(filter); } }
	 @Override
	...
	static class UnmodifiableCollection implements FloatCollection , java.io.Serializable {
	 ...
	 @Override
	 public void forEach(final FloatConsumer action) { collection.forEach(action); }
	 @Override
	...
	public static class IterableCollection extends AbstractFloatCollection implements java.io.Serializable {
	 ...
	 @Override
	 public FloatSpliterator spliterator() { return iterable.spliterator(); }
	 @Override
	 public DoubleIterator doubleIterator() { return iterable.doubleIterator() ; }
	 @Override
	 public DoubleSpliterator doubleSpliterator() { return iterable.doubleSpliterator() ; }
	}
