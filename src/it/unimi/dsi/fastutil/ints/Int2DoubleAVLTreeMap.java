	...
	public ObjectSortedSet<Int2DoubleMap.Entry > int2DoubleEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry >() {
	   final Comparator<? super Int2DoubleMap.Entry > comparator = (Int2DoubleAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Int2DoubleMap.Entry >) (x, y) -> ( Integer.compare((x.getIntKey()),(y.getIntKey())) ) :
	    (Comparator<Int2DoubleMap.Entry >) (x, y) -> Int2DoubleAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey())
	   );
	   @Override
