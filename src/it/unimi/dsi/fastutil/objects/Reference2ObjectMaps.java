...
public final class Reference2ObjectMaps {
	...
	public static <K,V> ObjectIterable<Reference2ObjectMap.Entry <K,V> > fastIterable(Reference2ObjectMap <K,V> map) {
	 ...
	 return entries instanceof Reference2ObjectMap.FastEntrySet ? new ObjectIterable<Reference2ObjectMap.Entry <K,V> >() {
	  ...
	  @Override
	  public ObjectSpliterator<Reference2ObjectMap.Entry <K,V> > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class UnmodifiableMap <K,V> extends Reference2ObjectFunctions.UnmodifiableFunction <K,V> implements Reference2ObjectMap <K,V>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Reference2ObjectMap.Entry <K,V> > reference2ObjectEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.reference2ObjectEntrySet()); return entries; }
	 /** {@inheritDoc} */
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Map.Entry<K, V>> entrySet() { return (ObjectSet)reference2ObjectEntrySet(); }
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public V getOrDefault(final Object key, final V defaultValue) { return ((Reference2ObjectMap <K,V>)map).getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 */
	public static <K,V> Reference2ObjectMap <K,V> unmodifiable(final Reference2ObjectMap <? extends K, ? extends V> m) { return new UnmodifiableMap <>(m); }
}
