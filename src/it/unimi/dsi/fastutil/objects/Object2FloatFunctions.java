...
public final class Object2FloatFunctions {
	...
	public static class EmptyFunction <K> extends AbstractObject2FloatFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public float getOrDefault(final Object k, final float defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton <K> extends AbstractObject2FloatFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public float getOrDefault(final Object k, final float defaultValue) { return java.util.Objects.equals(key, k) ? value : defaultValue; }
	 @Override
	...
	public static class UnmodifiableFunction <K> extends AbstractObject2FloatFunction <K> implements java.io.Serializable {
	 ...
	 public float getOrDefault(final Object k, final float defaultValue) { return ((Object2FloatFunction <K>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 */
	public static <K> Object2FloatFunction <K> unmodifiable(final Object2FloatFunction <? extends K> f) { return new UnmodifiableFunction <>(f); }
