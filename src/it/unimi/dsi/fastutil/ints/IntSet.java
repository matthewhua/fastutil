...
public interface IntSet extends IntCollection , Set<Integer> {
	...
	default IntSpliterator spliterator() {
	 return IntSpliterators.asSpliterator(
	   iterator(), sizeOf(this), IntSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
	}
	...
	public static IntSet of(int... a) {
	 ...
	 IntSet innerSet = a.length <= IntSets.ARRAY_SET_CUTOFF ?
	  new IntArraySet (a.length) :
	  new IntOpenHashSet (a.length);
	 for (int element : a) {
