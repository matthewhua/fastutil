...
public final class Object2LongMaps {
	...
	public static <K> ObjectIterable<Object2LongMap.Entry <K> > fastIterable(Object2LongMap <K> map) {
	 ...
	 return entries instanceof Object2LongMap.FastEntrySet ? new ObjectIterable<Object2LongMap.Entry <K> >() {
	  ...
	  @Override
	  public ObjectSpliterator<Object2LongMap.Entry <K> > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class SynchronizedMap <K> extends Object2LongFunctions.SynchronizedFunction <K> implements Object2LongMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public long computeIfAbsent(final K key, final Object2LongFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap <K> extends Object2LongFunctions.UnmodifiableFunction <K> implements Object2LongMap <K>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Object2LongMap.Entry <K> > object2LongEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2LongEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public long getOrDefault(final Object key, final long defaultValue) { return ((Object2LongMap <K>)map).getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 @Override
	 public long computeIfAbsent(final K key, final Object2LongFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 */
	public static <K> Object2LongMap <K> unmodifiable(final Object2LongMap <? extends K> m) { return new UnmodifiableMap <>(m); }
}
