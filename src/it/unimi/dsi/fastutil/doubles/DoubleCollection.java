...
public interface DoubleCollection extends Collection<Double>, DoubleIterable {
	 ...
	 */
	@Override
	default DoubleIterator doubleIterator() { return iterator(); }
	...
	default DoubleSpliterator spliterator() {
	 return DoubleSpliterators.asSpliterator(
	   iterator(), sizeOf(this), DoubleSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
	}
	 ...
	 */
	@Override
	default DoubleSpliterator doubleSpliterator() { return spliterator(); }
	...
	default boolean removeIf(final java.util.function.Predicate<? super Double> filter) {
	 return removeIf(
	  filter instanceof java.util.function.DoublePredicate ?
	   ((java.util.function.DoublePredicate) filter) :
	   (java.util.function.DoublePredicate) key -> filter.test(Double.valueOf(key)));
	}
	...
	@Deprecated
	@Override
	default java.util.stream.Stream<Double> stream() { return Collection.super.stream(); }
	...
	@Deprecated
	@Override
	default java.util.stream.Stream<Double> parallelStream() { return Collection.super.parallelStream(); }
