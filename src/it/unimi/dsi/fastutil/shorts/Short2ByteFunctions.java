...
public final class Short2ByteFunctions {
	...
	public static class EmptyFunction extends AbstractShort2ByteFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public byte getOrDefault(final short k, final byte defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractShort2ByteFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public byte getOrDefault(final short k, final byte defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Short2ByteFunction , java.io.Serializable {
	 ...
	 @Override
	 public byte getOrDefault(final short k, final byte defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractShort2ByteFunction implements java.io.Serializable {
	 ...
	 @Override
	 public byte getOrDefault(final short k, final byte defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
