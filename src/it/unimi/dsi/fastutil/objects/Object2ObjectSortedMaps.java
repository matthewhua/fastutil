...
public final class Object2ObjectSortedMaps {
	...
	public static class UnmodifiableSortedMap <K,V> extends Object2ObjectMaps.UnmodifiableMap <K,V> implements Object2ObjectSortedMap <K,V>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "rawtypes", "unchecked" })
	 @Override
	 public ObjectSortedSet<Object2ObjectMap.Entry <K,V> > object2ObjectEntrySet() { if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.object2ObjectEntrySet()); return (ObjectSortedSet<Object2ObjectMap.Entry <K,V> >)entries; }
	 /** {@inheritDoc} */
	 @Override
	 @SuppressWarnings({ "rawtypes", "unchecked" })
	 public ObjectSortedSet<Map.Entry<K, V>> entrySet() { return (ObjectSortedSet)object2ObjectEntrySet(); }
	 ...
	 */
	public static <K,V> Object2ObjectSortedMap <K,V> unmodifiable(final Object2ObjectSortedMap <K, ? extends V> m) { return new UnmodifiableSortedMap <>(m); }
}
