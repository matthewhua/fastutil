...
public final class Short2IntFunctions {
	...
	public static class EmptyFunction extends AbstractShort2IntFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int getOrDefault(final short k, final int defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractShort2IntFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int getOrDefault(final short k, final int defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Short2IntFunction , java.io.Serializable {
	 ...
	 @Override
	 public int getOrDefault(final short k, final int defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractShort2IntFunction implements java.io.Serializable {
	 ...
	 @Override
	 public int getOrDefault(final short k, final int defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
