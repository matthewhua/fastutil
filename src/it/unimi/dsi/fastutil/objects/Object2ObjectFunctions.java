...
public final class Object2ObjectFunctions {
	...
	public static class UnmodifiableFunction <K,V> extends AbstractObject2ObjectFunction <K,V> implements java.io.Serializable {
	 ...
	 public V getOrDefault(final Object k, final V defaultValue) { return ((Object2ObjectFunction <K,V>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 */
	public static <K,V> Object2ObjectFunction <K,V> unmodifiable(final Object2ObjectFunction <? extends K, ? extends V> f) { return new UnmodifiableFunction <>(f); }
}
