...
public final class Long2ShortMaps {
	...
	public static ObjectIterable<Long2ShortMap.Entry > fastIterable(Long2ShortMap map) {
	 ...
	 return entries instanceof Long2ShortMap.FastEntrySet ? new ObjectIterable<Long2ShortMap.Entry >() {
	  ...
	  @Override
	  public ObjectSpliterator<Long2ShortMap.Entry > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class EmptyMap extends Long2ShortFunctions.EmptyFunction implements Long2ShortMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short getOrDefault(final long key, final short defaultValue) { return defaultValue; }
	 /** {@inheritDoc}
	...
	public static class SynchronizedMap extends Long2ShortFunctions.SynchronizedFunction implements Long2ShortMap , java.io.Serializable {
	 ...
	 @Override
	 public short computeIfAbsent(final long key, final Long2ShortFunction mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap extends Long2ShortFunctions.UnmodifiableFunction implements Long2ShortMap , java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Long2ShortMap.Entry > long2ShortEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.long2ShortEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 @Override
	 public short computeIfAbsent(final long key, final Long2ShortFunction mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
