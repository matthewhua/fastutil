...
public final class Int2ObjectFunctions {
	...
	public static class UnmodifiableFunction <V> extends AbstractInt2ObjectFunction <V> implements java.io.Serializable {
	 ...
	 public V getOrDefault(final int k, final V defaultValue) { return ((Int2ObjectFunction <V>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public V getOrDefault(final Object k, final V defaultValue) { return ((Int2ObjectFunction <V>)function).getOrDefault(k, defaultValue); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <V> Int2ObjectFunction <V> unmodifiable(final Int2ObjectFunction <? extends V> f) { return new UnmodifiableFunction <>(f); }
