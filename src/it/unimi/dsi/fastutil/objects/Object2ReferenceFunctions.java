...
public final class Object2ReferenceFunctions {
	...
	public static class EmptyFunction <K,V> extends AbstractObject2ReferenceFunction <K,V> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public V getOrDefault(final Object k, final V defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton <K,V> extends AbstractObject2ReferenceFunction <K,V> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public V getOrDefault(final Object k, final V defaultValue) { return java.util.Objects.equals(key, k) ? value : defaultValue; }
	 @Override
	...
	public static class UnmodifiableFunction <K,V> extends AbstractObject2ReferenceFunction <K,V> implements java.io.Serializable {
	 ...
	 public V getOrDefault(final Object k, final V defaultValue) { return ((Object2ReferenceFunction <K,V>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 */
	public static <K,V> Object2ReferenceFunction <K,V> unmodifiable(final Object2ReferenceFunction <? extends K, ? extends V> f) { return new UnmodifiableFunction <>(f); }
}
