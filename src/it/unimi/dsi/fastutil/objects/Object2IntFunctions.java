...
public final class Object2IntFunctions {
	...
	public static class EmptyFunction <K> extends AbstractObject2IntFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int getOrDefault(final Object k, final int defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton <K> extends AbstractObject2IntFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int getOrDefault(final Object k, final int defaultValue) { return java.util.Objects.equals(key, k) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction <K> implements Object2IntFunction <K>, java.io.Serializable {
	 ...
	 @Override
	 public int getOrDefault(final Object k, final int defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction <K> extends AbstractObject2IntFunction <K> implements java.io.Serializable {
	 ...
	 public int getOrDefault(final Object k, final int defaultValue) { return ((Object2IntFunction <K>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public Integer getOrDefault(final Object k, final Integer defaultValue) { return ((Object2IntFunction <K>)function).getOrDefault(k, defaultValue); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <K> Object2IntFunction <K> unmodifiable(final Object2IntFunction <? extends K> f) { return new UnmodifiableFunction <>(f); }
