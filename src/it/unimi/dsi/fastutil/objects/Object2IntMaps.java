...
public final class Object2IntMaps {
	...
	public static <K> ObjectIterable<Object2IntMap.Entry <K> > fastIterable(Object2IntMap <K> map) {
	 ...
	 return entries instanceof Object2IntMap.FastEntrySet ? new ObjectIterable<Object2IntMap.Entry <K> >() {
	  ...
	  @Override
	  public ObjectSpliterator<Object2IntMap.Entry <K> > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class SynchronizedMap <K> extends Object2IntFunctions.SynchronizedFunction <K> implements Object2IntMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public int computeIfAbsent(final K key, final Object2IntFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap <K> extends Object2IntFunctions.UnmodifiableFunction <K> implements Object2IntMap <K>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Object2IntMap.Entry <K> > object2IntEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2IntEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public int getOrDefault(final Object key, final int defaultValue) { return ((Object2IntMap <K>)map).getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 @Override
	 public int computeIfAbsent(final K key, final Object2IntFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public Integer getOrDefault(final Object key, final Integer defaultValue) { return ((Object2IntMap <K>)map).getOrDefault(key, defaultValue); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <K> Object2IntMap <K> unmodifiable(final Object2IntMap <? extends K> m) { return new UnmodifiableMap <>(m); }
}
