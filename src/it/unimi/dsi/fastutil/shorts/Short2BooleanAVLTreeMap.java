	...
	public ObjectSortedSet<Short2BooleanMap.Entry > short2BooleanEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry >() {
	   final Comparator<? super Short2BooleanMap.Entry > comparator = (Short2BooleanAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Short2BooleanMap.Entry >) (x, y) -> ( Short.compare((x.getShortKey()),(y.getShortKey())) ) :
	    (Comparator<Short2BooleanMap.Entry >) (x, y) -> Short2BooleanAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey())
	   );
	   @Override
