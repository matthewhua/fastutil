...
public final class ShortCollections {
	...
	public abstract static class EmptyCollection extends AbstractShortCollection {
	 ...
	 @Override
	 public boolean containsAll(final ShortCollection c) { return c.isEmpty(); }
	 @Override
	...
	static class SynchronizedCollection implements ShortCollection , java.io.Serializable {
	 ...
	 @Override
	 public ShortSpliterator spliterator() { return collection.spliterator(); }
	 @Deprecated
	 @Override
	 public java.util.stream.Stream <Short> stream() { return collection.stream(); }
	 @Deprecated
	 @Override
	 public java.util.stream.Stream <Short> parallelStream() { return collection.parallelStream(); }
	 @Override
	 public void forEach(final ShortConsumer action) { synchronized(sync) { collection.forEach(action); } }
	 @Override
	 ...
	 @Override
	 public boolean removeIf(final ShortPredicate filter) { synchronized(sync) { return collection.removeIf(filter); } }
	 @Override
	...
	static class UnmodifiableCollection implements ShortCollection , java.io.Serializable {
	 ...
	 @Override
	 public void forEach(final ShortConsumer action) { collection.forEach(action); }
	 @Override
	...
	public static class IterableCollection extends AbstractShortCollection implements java.io.Serializable {
	 ...
	 @Override
	 public ShortSpliterator spliterator() { return iterable.spliterator(); }
	 @Override
