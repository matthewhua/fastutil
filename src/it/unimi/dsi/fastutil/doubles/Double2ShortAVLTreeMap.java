	...
	public ObjectSortedSet<Double2ShortMap.Entry > double2ShortEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Double2ShortMap.Entry >() {
	   final Comparator<? super Double2ShortMap.Entry > comparator = (Double2ShortAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Double2ShortMap.Entry >) (x, y) -> ( Double.compare((x.getDoubleKey()),(y.getDoubleKey())) ) :
	    (Comparator<Double2ShortMap.Entry >) (x, y) -> Double2ShortAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey())
	   );
	   @Override
