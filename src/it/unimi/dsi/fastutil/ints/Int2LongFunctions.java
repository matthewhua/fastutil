...
public final class Int2LongFunctions {
	...
	public static class EmptyFunction extends AbstractInt2LongFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long getOrDefault(final int k, final long defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractInt2LongFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long getOrDefault(final int k, final long defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Int2LongFunction , java.io.Serializable {
	 ...
	 @Override
	 public long getOrDefault(final int k, final long defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractInt2LongFunction implements java.io.Serializable {
	 ...
	 @Override
	 public long getOrDefault(final int k, final long defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
