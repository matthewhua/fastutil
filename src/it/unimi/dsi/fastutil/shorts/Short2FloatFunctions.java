...
public final class Short2FloatFunctions {
	...
	public static class EmptyFunction extends AbstractShort2FloatFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public float getOrDefault(final short k, final float defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractShort2FloatFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public float getOrDefault(final short k, final float defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Short2FloatFunction , java.io.Serializable {
	 ...
	 @Override
	 public float getOrDefault(final short k, final float defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractShort2FloatFunction implements java.io.Serializable {
	 ...
	 @Override
	 public float getOrDefault(final short k, final float defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
