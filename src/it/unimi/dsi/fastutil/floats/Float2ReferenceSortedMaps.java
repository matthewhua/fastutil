...
public final class Float2ReferenceSortedMaps {
	...
	public static class UnmodifiableSortedMap <V> extends Float2ReferenceMaps.UnmodifiableMap <V> implements Float2ReferenceSortedMap <V>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "rawtypes", "unchecked" })
	 @Override
	 public ObjectSortedSet<Float2ReferenceMap.Entry <V> > float2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.float2ReferenceEntrySet()); return (ObjectSortedSet<Float2ReferenceMap.Entry <V> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <V> Float2ReferenceSortedMap <V> unmodifiable(final Float2ReferenceSortedMap <? extends V> m) { return new UnmodifiableSortedMap <>(m); }
}
