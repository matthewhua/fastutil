...
public final class Object2CharFunctions {
	...
	public static class EmptyFunction <K> extends AbstractObject2CharFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char getOrDefault(final Object k, final char defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton <K> extends AbstractObject2CharFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char getOrDefault(final Object k, final char defaultValue) { return java.util.Objects.equals(key, k) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction <K> implements Object2CharFunction <K>, java.io.Serializable {
	 ...
	 @Override
	 public char getOrDefault(final Object k, final char defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	 ...
	 @Deprecated
	 @Override
	 public Character getOrDefault(final Object k, final Character defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	...
	public static class UnmodifiableFunction <K> extends AbstractObject2CharFunction <K> implements java.io.Serializable {
	 ...
	 public char getOrDefault(final Object k, final char defaultValue) { return ((Object2CharFunction <K>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public Character getOrDefault(final Object k, final Character defaultValue) { return ((Object2CharFunction <K>)function).getOrDefault(k, defaultValue); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <K> Object2CharFunction <K> unmodifiable(final Object2CharFunction <? extends K> f) { return new UnmodifiableFunction <>(f); }
