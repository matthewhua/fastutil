...
public final class Object2ByteFunctions {
	...
	public static class EmptyFunction <K> extends AbstractObject2ByteFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public byte getOrDefault(final Object k, final byte defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton <K> extends AbstractObject2ByteFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public byte getOrDefault(final Object k, final byte defaultValue) { return java.util.Objects.equals(key, k) ? value : defaultValue; }
	 @Override
	...
	public static class UnmodifiableFunction <K> extends AbstractObject2ByteFunction <K> implements java.io.Serializable {
	 ...
	 public byte getOrDefault(final Object k, final byte defaultValue) { return ((Object2ByteFunction <K>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 */
	public static <K> Object2ByteFunction <K> unmodifiable(final Object2ByteFunction <? extends K> f) { return new UnmodifiableFunction <>(f); }
