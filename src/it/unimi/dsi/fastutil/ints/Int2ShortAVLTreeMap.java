	...
	public ObjectSortedSet<Int2ShortMap.Entry > int2ShortEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Int2ShortMap.Entry >() {
	   final Comparator<? super Int2ShortMap.Entry > comparator = (Int2ShortAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Int2ShortMap.Entry >) (x, y) -> ( Integer.compare((x.getIntKey()),(y.getIntKey())) ) :
	    (Comparator<Int2ShortMap.Entry >) (x, y) -> Int2ShortAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey())
	   );
	   @Override
