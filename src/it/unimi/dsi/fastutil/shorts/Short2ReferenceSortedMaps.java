...
public final class Short2ReferenceSortedMaps {
	...
	public static class UnmodifiableSortedMap <V> extends Short2ReferenceMaps.UnmodifiableMap <V> implements Short2ReferenceSortedMap <V>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "rawtypes", "unchecked" })
	 @Override
	 public ObjectSortedSet<Short2ReferenceMap.Entry <V> > short2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.short2ReferenceEntrySet()); return (ObjectSortedSet<Short2ReferenceMap.Entry <V> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <V> Short2ReferenceSortedMap <V> unmodifiable(final Short2ReferenceSortedMap <? extends V> m) { return new UnmodifiableSortedMap <>(m); }
}
