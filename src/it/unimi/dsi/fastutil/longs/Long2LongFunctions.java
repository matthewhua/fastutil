...
public final class Long2LongFunctions {
	...
	public static class EmptyFunction extends AbstractLong2LongFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long getOrDefault(final long k, final long defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractLong2LongFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long getOrDefault(final long k, final long defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Long2LongFunction , java.io.Serializable {
	 ...
	 @Override
	 public long getOrDefault(final long k, final long defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractLong2LongFunction implements java.io.Serializable {
	 ...
	 @Override
	 public long getOrDefault(final long k, final long defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
