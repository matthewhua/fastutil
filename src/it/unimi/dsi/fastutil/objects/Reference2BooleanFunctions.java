...
public final class Reference2BooleanFunctions {
	...
	public static class Singleton <K> extends AbstractReference2BooleanFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean getOrDefault(final Object k, final boolean defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class UnmodifiableFunction <K> extends AbstractReference2BooleanFunction <K> implements java.io.Serializable {
	 ...
	 public boolean getOrDefault(final Object k, final boolean defaultValue) { return ((Reference2BooleanFunction <K>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 */
	public static <K> Reference2BooleanFunction <K> unmodifiable(final Reference2BooleanFunction <? extends K> f) { return new UnmodifiableFunction <>(f); }
