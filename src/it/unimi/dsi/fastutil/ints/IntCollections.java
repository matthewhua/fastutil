...
public final class IntCollections {
	...
	public abstract static class EmptyCollection extends AbstractIntCollection {
	 ...
	 public IntSpliterator spliterator() { return IntSpliterators.EMPTY_SPLITERATOR; }
	 @Override
	 ...
	 @Override
	 public boolean containsAll(final IntCollection c) { return c.isEmpty(); }
	 @Override
	...
	static class SynchronizedCollection implements IntCollection , java.io.Serializable {
	 ...
	 @Override
	 public IntSpliterator spliterator() { return collection.spliterator(); }
	 @Deprecated
	 @Override
	 public java.util.stream.Stream <Integer> stream() { return collection.stream(); }
	 @Deprecated
	 @Override
	 public java.util.stream.Stream <Integer> parallelStream() { return collection.parallelStream(); }
	 @Override
	 public void forEach(final java.util.function.IntConsumer action) { synchronized(sync) { collection.forEach(action); } }
	 @Override
	...
	static class UnmodifiableCollection implements IntCollection , java.io.Serializable {
	 ...
	 @Override
	 public void forEach(final java.util.function.IntConsumer action) { collection.forEach(action); }
	 @Override
	...
	public static class IterableCollection extends AbstractIntCollection implements java.io.Serializable {
	 ...
	 @Override
	 public IntSpliterator spliterator() { return iterable.spliterator(); }
	 @Override
	...
	static class SizeDecreasingSupplier<
	  C extends IntCollection > implements Supplier<C> {
