...
public final class Reference2CharFunctions {
	...
	public static class Singleton <K> extends AbstractReference2CharFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char getOrDefault(final Object k, final char defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class UnmodifiableFunction <K> extends AbstractReference2CharFunction <K> implements java.io.Serializable {
	 ...
	 public char getOrDefault(final Object k, final char defaultValue) { return ((Reference2CharFunction <K>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public Character getOrDefault(final Object k, final Character defaultValue) { return ((Reference2CharFunction <K>)function).getOrDefault(k, defaultValue); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <K> Reference2CharFunction <K> unmodifiable(final Reference2CharFunction <? extends K> f) { return new UnmodifiableFunction <>(f); }
