...
public final class Float2IntFunctions {
	...
	public static class EmptyFunction extends AbstractFloat2IntFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int getOrDefault(final float k, final int defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractFloat2IntFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int getOrDefault(final float k, final int defaultValue) { return ( Float.floatToIntBits(key) == Float.floatToIntBits(k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Float2IntFunction , java.io.Serializable {
	 ...
	 @Override
	 public int getOrDefault(final float k, final int defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractFloat2IntFunction implements java.io.Serializable {
	 ...
	 @Override
	 public int getOrDefault(final float k, final int defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
