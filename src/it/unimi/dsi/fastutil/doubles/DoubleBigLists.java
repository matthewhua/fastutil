...
public final class DoubleBigLists {
	...
	public static class EmptyBigList extends DoubleCollections.EmptyCollection implements DoubleBigList , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public void getElements(long from, double[][] a, long offset, long length) { BigArrays.ensureOffsetLength(a, offset, length); if (from != 0) throw new IndexOutOfBoundsException(); }
	 @Override
	...
	public static class Singleton extends AbstractDoubleBigList implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long indexOf(final double k) { return ( Double.doubleToLongBits(k) == Double.doubleToLongBits(element) ) ? 0 : -1; }
