...
public final class Short2ReferenceMaps {
	...
	public static <V> ObjectIterable<Short2ReferenceMap.Entry <V> > fastIterable(Short2ReferenceMap <V> map) {
	 ...
	 return entries instanceof Short2ReferenceMap.FastEntrySet ? new ObjectIterable<Short2ReferenceMap.Entry <V> >() {
	  ...
	  @Override
	  public ObjectSpliterator<Short2ReferenceMap.Entry <V> > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class EmptyMap <V> extends Short2ReferenceFunctions.EmptyFunction <V> implements Short2ReferenceMap <V>, java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public V getOrDefault(final short key, final V defaultValue) { return defaultValue; }
	 @Override
	...
	public static class SynchronizedMap <V> extends Short2ReferenceFunctions.SynchronizedFunction <V> implements Short2ReferenceMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public V computeIfAbsent(final short key, final Short2ReferenceFunction <? extends V> mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap <V> extends Short2ReferenceFunctions.UnmodifiableFunction <V> implements Short2ReferenceMap <V>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Short2ReferenceMap.Entry <V> > short2ReferenceEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.short2ReferenceEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public V getOrDefault(final short key, final V defaultValue) { return ((Short2ReferenceMap <V>)map).getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 @Override
	 public V computeIfAbsent(final short key, final Short2ReferenceFunction <? extends V> mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public V getOrDefault(final Object key, final V defaultValue) { return ((Short2ReferenceMap <V>)map).getOrDefault(key, defaultValue); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <V> Short2ReferenceMap <V> unmodifiable(final Short2ReferenceMap <? extends V> m) { return new UnmodifiableMap <>(m); }
}
