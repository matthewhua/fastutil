...
public final class Float2ReferenceFunctions {
	...
	public static class EmptyFunction <V> extends AbstractFloat2ReferenceFunction <V> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public V getOrDefault(final float k, final V defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton <V> extends AbstractFloat2ReferenceFunction <V> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public V getOrDefault(final float k, final V defaultValue) { return ( Float.floatToIntBits(key) == Float.floatToIntBits(k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction <V> implements Float2ReferenceFunction <V>, java.io.Serializable {
	 ...
	 @Override
	 public V getOrDefault(final float k, final V defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction <V> extends AbstractFloat2ReferenceFunction <V> implements java.io.Serializable {
	 ...
	 public V getOrDefault(final float k, final V defaultValue) { return ((Float2ReferenceFunction <V>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public V getOrDefault(final Object k, final V defaultValue) { return ((Float2ReferenceFunction <V>)function).getOrDefault(k, defaultValue); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <V> Float2ReferenceFunction <V> unmodifiable(final Float2ReferenceFunction <? extends V> f) { return new UnmodifiableFunction <>(f); }
