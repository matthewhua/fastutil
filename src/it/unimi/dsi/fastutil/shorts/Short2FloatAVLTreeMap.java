	...
	public ObjectSortedSet<Short2FloatMap.Entry > short2FloatEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Short2FloatMap.Entry >() {
	   final Comparator<? super Short2FloatMap.Entry > comparator = (Short2FloatAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Short2FloatMap.Entry >) (x, y) -> ( Short.compare((x.getShortKey()),(y.getShortKey())) ) :
	    (Comparator<Short2FloatMap.Entry >) (x, y) -> Short2FloatAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey())
	   );
	   @Override
