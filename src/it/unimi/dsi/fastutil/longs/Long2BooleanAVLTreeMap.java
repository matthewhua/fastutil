	...
	public ObjectSortedSet<Long2BooleanMap.Entry > long2BooleanEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2BooleanMap.Entry >() {
	   final Comparator<? super Long2BooleanMap.Entry > comparator = (Long2BooleanAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Long2BooleanMap.Entry >) (x, y) -> ( Long.compare((x.getLongKey()),(y.getLongKey())) ) :
	    (Comparator<Long2BooleanMap.Entry >) (x, y) -> Long2BooleanAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey())
	   );
	   @Override
