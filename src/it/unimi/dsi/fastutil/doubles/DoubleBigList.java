...
public interface DoubleBigList extends BigList<Double>, DoubleCollection , Comparable<BigList<? extends Double>> {
	...
	default DoubleSpliterator spliterator() {
	 return DoubleSpliterators.asSpliterator(
	   iterator(), size64(), DoubleSpliterators.LIST_SPLITERATOR_CHARACTERISTICS);
	}
	 ...
	 */
	default boolean addAll(final long index, final DoubleBigList l) { return addAll(index, (DoubleCollection ) l); }
	 ...
	 */
	default boolean addAll(final DoubleBigList l) { return addAll(size64(), l); }
	 ...
	 * @see BigList#addAll(long,Collection)
	 */
	default boolean addAll(final long index, final DoubleList l) { return addAll(index, (DoubleCollection ) l); }
	 ...
	 * @see BigList#addAll(Collection)
	 */
	default boolean addAll(final DoubleList l) { return addAll(size64(), l); }
