...
public final class Int2CharMaps {
	...
	public static ObjectIterable<Int2CharMap.Entry > fastIterable(Int2CharMap map) {
	 ...
	 return entries instanceof Int2CharMap.FastEntrySet ? new ObjectIterable<Int2CharMap.Entry >() {
	  ...
	  @Override
	  public ObjectSpliterator<Int2CharMap.Entry > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class EmptyMap extends Int2CharFunctions.EmptyFunction implements Int2CharMap , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char getOrDefault(final int key, final char defaultValue) { return defaultValue; }
	 /** {@inheritDoc}
	...
	public static class SynchronizedMap extends Int2CharFunctions.SynchronizedFunction implements Int2CharMap , java.io.Serializable {
	 ...
	 @Override
	 public char computeIfAbsent(final int key, final Int2CharFunction mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap extends Int2CharFunctions.UnmodifiableFunction implements Int2CharMap , java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Int2CharMap.Entry > int2CharEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.int2CharEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 @Override
	 public char computeIfAbsent(final int key, final Int2CharFunction mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
