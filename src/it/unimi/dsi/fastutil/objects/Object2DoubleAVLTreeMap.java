	...
	public ObjectSortedSet<Object2DoubleMap.Entry <K> > object2DoubleEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry <K> >() {
	   final Comparator<? super Object2DoubleMap.Entry <K> > comparator = (Object2DoubleAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Object2DoubleMap.Entry <K> >) (x, y) -> ( ((Comparable<K>)(x.getKey())).compareTo(y.getKey()) ) :
	    (Comparator<Object2DoubleMap.Entry <K> >) (x, y) -> Object2DoubleAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey())
	   );
	   @Override
