...
public final class Double2ReferenceSortedMaps {
	...
	public static class UnmodifiableSortedMap <V> extends Double2ReferenceMaps.UnmodifiableMap <V> implements Double2ReferenceSortedMap <V>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "rawtypes", "unchecked" })
	 @Override
	 public ObjectSortedSet<Double2ReferenceMap.Entry <V> > double2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.double2ReferenceEntrySet()); return (ObjectSortedSet<Double2ReferenceMap.Entry <V> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <V> Double2ReferenceSortedMap <V> unmodifiable(final Double2ReferenceSortedMap <? extends V> m) { return new UnmodifiableSortedMap <>(m); }
}
