...
public final class ShortIterators {
	...
	private static class PrimitiveIteratorWrapper implements ShortIterator {
	 ...
	 public void remove() { i.remove(); }
	 @Override
	 public short nextShort() { return (short)i.nextInt(); }
	 @Override
	 public void forEachRemaining(final ShortConsumer action) {
	  i.forEachRemaining(action);
	 }
	...
	private static class CheckedPrimitiveIteratorWrapper extends PrimitiveIteratorWrapper {
	 ...
	 @Override
	 public short nextShort() { return it.unimi.dsi.fastutil.SafeMath.safeIntToShort(i.nextInt()); }
	 @Override
	 public void forEachRemaining(final ShortConsumer action) {
	  i.forEachRemaining((java.util.function.IntConsumer)(int value) -> { action.accept(it.unimi.dsi.fastutil.SafeMath.safeIntToShort(value)); });
	 }
	}
	 ...
	 * @since 8.5.0
	 */
	public static IntIterator widen(ShortIterator i) { return IntIterators.wrap(i); }
	...
	public static abstract class AbstractIndexBasedIterator extends AbstractShortIterator {
	 ...
	 @Override
	 public short nextShort() { if (! hasNext()) throw new NoSuchElementException(); return get(lastReturned = pos++); }
	 @Override
	 public void remove() {
	...
	public static abstract class AbstractIndexBasedListIterator extends AbstractIndexBasedIterator implements ShortListIterator {
	 ...
	 @Override
	 public short previousShort() { if (! hasPrevious()) throw new NoSuchElementException(); return get(lastReturned = --pos); }
	 @Override
