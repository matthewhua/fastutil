...
public final class Object2BooleanMaps {
	...
	public static <K> ObjectIterable<Object2BooleanMap.Entry <K> > fastIterable(Object2BooleanMap <K> map) {
	 ...
	 return entries instanceof Object2BooleanMap.FastEntrySet ? new ObjectIterable<Object2BooleanMap.Entry <K> >() {
	  ...
	  @Override
	  public ObjectSpliterator<Object2BooleanMap.Entry <K> > spliterator() { return entries.spliterator(); }
	  @Override
	...
	public static class SynchronizedMap <K> extends Object2BooleanFunctions.SynchronizedFunction <K> implements Object2BooleanMap <K>, java.io.Serializable {
	 ...
	 @Override
	 public boolean computeIfAbsent(final K key, final Object2BooleanFunction <? super K> mappingFunction) { synchronized(sync) { return map.computeIfAbsent(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap <K> extends Object2BooleanFunctions.UnmodifiableFunction <K> implements Object2BooleanMap <K>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 @Override
	 public ObjectSet<Object2BooleanMap.Entry <K> > object2BooleanEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable((ObjectSet)map.object2BooleanEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	 ...
	 @Override
	 @SuppressWarnings("unchecked")
	 public boolean getOrDefault(final Object key, final boolean defaultValue) { return ((Object2BooleanMap <K>)map).getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 @Override
	 public boolean computeIfAbsent(final K key, final Object2BooleanFunction <? super K> mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 */
	public static <K> Object2BooleanMap <K> unmodifiable(final Object2BooleanMap <? extends K> m) { return new UnmodifiableMap <>(m); }
}
