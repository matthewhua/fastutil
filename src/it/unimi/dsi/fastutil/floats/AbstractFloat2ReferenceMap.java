	 ...
	 return new AbstractFloatSet () {
	   ...
	   public FloatSpliterator spliterator() {
	    return FloatSpliterators.asSpliterator(
	     iterator(), sizeOf(AbstractFloat2ReferenceMap.this), FloatSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
	   }
	  };
	}
	...
	public ReferenceCollection <V> values() {
	 return new AbstractReferenceCollection <V>() {
	   ...
	   public ObjectSpliterator <V> spliterator() {
	    return ObjectSpliterators.asSpliterator(
	     iterator(), sizeOf(AbstractFloat2ReferenceMap.this), ObjectSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
	   }
	  };
	}
	/** {@inheritDoc} */
