	...
	public ObjectSortedSet<Long2CharMap.Entry > long2CharEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Long2CharMap.Entry >() {
	   final Comparator<? super Long2CharMap.Entry > comparator = (Long2CharAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Long2CharMap.Entry >) (x, y) -> ( Long.compare((x.getLongKey()),(y.getLongKey())) ) :
	    (Comparator<Long2CharMap.Entry >) (x, y) -> Long2CharAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey())
	   );
	   @Override
