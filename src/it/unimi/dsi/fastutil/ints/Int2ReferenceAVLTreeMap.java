	...
	public ObjectSortedSet<Int2ReferenceMap.Entry <V> > int2ReferenceEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry <V> >() {
	   final Comparator<? super Int2ReferenceMap.Entry <V> > comparator = (Int2ReferenceAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Int2ReferenceMap.Entry <V> >) (x, y) -> ( Integer.compare((x.getIntKey()),(y.getIntKey())) ) :
	    (Comparator<Int2ReferenceMap.Entry <V> >) (x, y) -> Int2ReferenceAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey())
	   );
	   @Override
