...
public final class Int2CharFunctions {
	...
	public static class EmptyFunction extends AbstractInt2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char getOrDefault(final int k, final char defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractInt2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char getOrDefault(final int k, final char defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Int2CharFunction , java.io.Serializable {
	 ...
	 @Override
	 public char getOrDefault(final int k, final char defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractInt2CharFunction implements java.io.Serializable {
	 ...
	 @Override
	 public char getOrDefault(final int k, final char defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
