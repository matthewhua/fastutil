...
public interface ReferenceBigList <K> extends BigList<K>, ReferenceCollection <K> {
	...
	default ObjectSpliterator <K> spliterator() {
	 return ObjectSpliterators.asSpliterator(
	   iterator(), size64(), ObjectSpliterators.LIST_SPLITERATOR_CHARACTERISTICS);
	}
	 ...
	 */
	default boolean addAll(final long index, final ReferenceBigList <? extends K> l) { return addAll(index, (ReferenceCollection <? extends K>) l); }
	 ...
	 */
	default boolean addAll(final ReferenceBigList <? extends K> l) { return addAll(size64(), l); }
	 ...
	 * @see BigList#addAll(long,Collection)
	 */
	default boolean addAll(final long index, final ReferenceList <? extends K> l) { return addAll(index, (ReferenceCollection <? extends K>) l); }
	 ...
	 * @see BigList#addAll(Collection)
	 */
	default boolean addAll(final ReferenceList <? extends K> l) { return addAll(size64(), l); }
