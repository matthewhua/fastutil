...
public final class Reference2DoubleFunctions {
	...
	public static class Singleton <K> extends AbstractReference2DoubleFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public double getOrDefault(final Object k, final double defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class UnmodifiableFunction <K> extends AbstractReference2DoubleFunction <K> implements java.io.Serializable {
	 ...
	 public double getOrDefault(final Object k, final double defaultValue) { return ((Reference2DoubleFunction <K>) function).getOrDefault(k, defaultValue); }
	 @Override
	 ...
	 */
	public static <K> Reference2DoubleFunction <K> unmodifiable(final Reference2DoubleFunction <? extends K> f) { return new UnmodifiableFunction <>(f); }
