	...
	public ObjectSortedSet<Object2BooleanMap.Entry <K> > object2BooleanEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry <K> >() {
	   final Comparator<? super Object2BooleanMap.Entry <K> > comparator = (Object2BooleanAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Object2BooleanMap.Entry <K> >) (x, y) -> ( ((Comparable<K>)(x.getKey())).compareTo(y.getKey()) ) :
	    (Comparator<Object2BooleanMap.Entry <K> >) (x, y) -> Object2BooleanAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey())
	   );
	   @Override
