	...
	public ObjectSortedSet<Int2FloatMap.Entry > int2FloatEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Int2FloatMap.Entry >() {
	   final Comparator<? super Int2FloatMap.Entry > comparator = (Int2FloatAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Int2FloatMap.Entry >) (x, y) -> ( Integer.compare((x.getIntKey()),(y.getIntKey())) ) :
	    (Comparator<Int2FloatMap.Entry >) (x, y) -> Int2FloatAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey())
	   );
	   @Override
