...
public final class ObjectIterators {
	...
	public static abstract class AbstractIndexBasedIterator <K> extends AbstractObjectIterator <K> {
	 ...
	 @Override
	 public K next() { if (! hasNext()) throw new NoSuchElementException(); return get(lastReturned = pos++); }
	 @Override
	 public void remove() {
	...
	public static abstract class AbstractIndexBasedListIterator <K> extends AbstractIndexBasedIterator <K> implements ObjectListIterator <K> {
	 ...
	 @Override
	 public K previous() { if (! hasPrevious()) throw new NoSuchElementException(); return get(lastReturned = --pos); }
	 @Override
	 ...
	 */
	public static <K> ObjectIterator <K> unmodifiable(final ObjectIterator <? extends K> i) { return new UnmodifiableIterator <>(i); }
	 ...
	 */
	public static <K> ObjectBidirectionalIterator <K> unmodifiable(final ObjectBidirectionalIterator <? extends K> i) { return new UnmodifiableBidirectionalIterator <>(i); }
	 ...
	 */
	public static <K> ObjectListIterator <K> unmodifiable(final ObjectListIterator <? extends K> i) { return new UnmodifiableListIterator <>(i); }
}
