...
public final class ShortSpliterators {
	...
	public static class EmptySpliterator implements ShortSpliterator , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean tryAdvance(final ShortConsumer action) { return false; }
	 @Deprecated
	 @Override
	 public boolean tryAdvance(final Consumer<? super Short> action) { return false; }
	 @Override
	 public ShortSpliterator trySplit() { return null; }
	 @Override
	 ...
	 * @return a spliterator that will iterate over {@code length} elements of {@code array} starting at position {@code offset}.
	 */
	public static ShortSpliterator wrapPreSorted(
	  final short[] array, final int offset, final int length, final int additionalCharacteristics, ShortComparator comparator) {
	 ShortArrays.ensureOffsetLength(array, offset, length);
	 ...
	 */
	public static ShortSpliterator wrapPreSorted(
	  final short[] array, final int offset, final int length, ShortComparator comparator) {
	 ...
	 */
	public static ShortSpliterator wrapPreSorted(
	  final short[] array, ShortComparator comparator) {
	 ...
	 */
	public static IntSpliterator widen(ShortSpliterator i) { return IntSpliterators.wrap(i); }
	/**
	...
	public static ShortSpliterator asSpliteratorFromSorted(
	  final ShortIterator iter, final long size, final int additionalCharacterisitcs, final ShortComparator comparator) {
