...
public final class Short2ShortFunctions {
	...
	public static class EmptyFunction extends AbstractShort2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short getOrDefault(final short k, final short defaultValue) { return defaultValue; }
	 @Override
	...
	public static class Singleton extends AbstractShort2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public short getOrDefault(final short k, final short defaultValue) { return ( (key) == (k) ) ? value : defaultValue; }
	 @Override
	...
	public static class SynchronizedFunction implements Short2ShortFunction , java.io.Serializable {
	 ...
	 @Override
	 public short getOrDefault(final short k, final short defaultValue) { synchronized(sync) { return function.getOrDefault(k, defaultValue); } }
	 @Override
	...
	public static class UnmodifiableFunction extends AbstractShort2ShortFunction implements java.io.Serializable {
	 ...
	 @Override
	 public short getOrDefault(final short k, final short defaultValue) { return function.getOrDefault(k, defaultValue); }
	 @Override
