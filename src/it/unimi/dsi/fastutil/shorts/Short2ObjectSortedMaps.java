...
public final class Short2ObjectSortedMaps {
	...
	public static class UnmodifiableSortedMap <V> extends Short2ObjectMaps.UnmodifiableMap <V> implements Short2ObjectSortedMap <V>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "rawtypes", "unchecked" })
	 @Override
	 public ObjectSortedSet<Short2ObjectMap.Entry <V> > short2ObjectEntrySet() { if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.short2ObjectEntrySet()); return (ObjectSortedSet<Short2ObjectMap.Entry <V> >)entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <V> Short2ObjectSortedMap <V> unmodifiable(final Short2ObjectSortedMap <? extends V> m) { return new UnmodifiableSortedMap <>(m); }
}
