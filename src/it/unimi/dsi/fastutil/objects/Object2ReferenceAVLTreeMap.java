	...
	public ObjectSortedSet<Object2ReferenceMap.Entry <K,V> > object2ReferenceEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Object2ReferenceMap.Entry <K,V> >() {
	   final Comparator<? super Object2ReferenceMap.Entry <K,V> > comparator = (Object2ReferenceAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Object2ReferenceMap.Entry <K,V> >) (x, y) -> ( ((Comparable<K>)(x.getKey())).compareTo(y.getKey()) ) :
	    (Comparator<Object2ReferenceMap.Entry <K,V> >) (x, y) -> Object2ReferenceAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey())
	   );
	   @Override
