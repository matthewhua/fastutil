	...
	public ObjectSortedSet<Float2ReferenceMap.Entry <V> > float2ReferenceEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Float2ReferenceMap.Entry <V> >() {
	   final Comparator<? super Float2ReferenceMap.Entry <V> > comparator = (Float2ReferenceAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Float2ReferenceMap.Entry <V> >) (x, y) -> ( Float.compare((x.getFloatKey()),(y.getFloatKey())) ) :
	    (Comparator<Float2ReferenceMap.Entry <V> >) (x, y) -> Float2ReferenceAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey())
	   );
	   @Override
