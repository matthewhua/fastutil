...
public final class Object2ReferenceSortedMaps {
	...
	public static class UnmodifiableSortedMap <K,V> extends Object2ReferenceMaps.UnmodifiableMap <K,V> implements Object2ReferenceSortedMap <K,V>, java.io.Serializable {
	 ...
	 @SuppressWarnings({ "rawtypes", "unchecked" })
	 @Override
	 public ObjectSortedSet<Object2ReferenceMap.Entry <K,V> > object2ReferenceEntrySet() { if (entries == null) entries = ObjectSortedSets.unmodifiable((ObjectSortedSet)sortedMap.object2ReferenceEntrySet()); return (ObjectSortedSet<Object2ReferenceMap.Entry <K,V> >)entries; }
	 /** {@inheritDoc} */
	 @Override
	 @SuppressWarnings({ "rawtypes", "unchecked" })
	 public ObjectSortedSet<Map.Entry<K, V>> entrySet() { return (ObjectSortedSet)object2ReferenceEntrySet(); }
	 ...
	 */
	public static <K,V> Object2ReferenceSortedMap <K,V> unmodifiable(final Object2ReferenceSortedMap <K, ? extends V> m) { return new UnmodifiableSortedMap <>(m); }
}
