	...
	public ObjectSortedSet<Float2CharMap.Entry > float2CharEntrySet() {
	 if (entries == null) entries = new AbstractObjectSortedSet<Float2CharMap.Entry >() {
	   final Comparator<? super Float2CharMap.Entry > comparator = (Float2CharAVLTreeMap.this.actualComparator == null ?
	    (Comparator<Float2CharMap.Entry >) (x, y) -> ( Float.compare((x.getFloatKey()),(y.getFloatKey())) ) :
	    (Comparator<Float2CharMap.Entry >) (x, y) -> Float2CharAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey())
	   );
	   @Override
